...
export class CatalogGuia {
  ...
  readonly componentCatalog = [
    {
      ...
      avoidWhen: "Nunca é reemplazaron ios-button-* eliminados.",
    ...
    },
    {
      ...
      avoidWhen: "Nunca é reemplazaron ion-input-* eliminados.",
      status: "Usar" as const,
    },
    {
      family: "Mobile data",
  ...
  readonly globalRules = [
    ...
    },
    {
      title: "Mobile",
      description:
        "Apilar formularios, ampliar botones y reemplazar tablas densas por cards.",
    },
    {
      title: "Sombras",
      description:
