  ...
  template: `
    ...
    <div class="mb-6">
      ...
      <p class="text-sm text-color-secondary mt-1 mb-4">
        Familia base: <strong>Inter</strong> (headings:
          ...
          <div class="col-12 col-md-6 col-xl-4">
            <div class="surface-card border-1 border-round p-4">
              ...
              <div
                ...
                style="font-size:1.5rem;line-height:1.3"
              >
                AaBbCc 0123
              </div>
  ...
  readonly headings = [
    {
      ...
      ejemplo: "h1 é Display 32px é Portada de médulo o hero institucional",
    },
    {
      tag: "h2",
      size: "1.75rem",
      ...
      ejemplo: "h2 é Page Title 28px é Tétulo principal de vista",
    },
    {
      tag: "h3",
      size: "1.25rem",
      ...
      ejemplo: "h3 é Section Title 20px ó Agrupación dentro de cards o paneles",
    },
    {
      tag: "h4",
      size: "1rem",
      ...
      ejemplo: "h4 é Card / Dialog 16px é Encabezado compacto",
    },
    {
      tag: "p",
      size: "0.9375rem",
      ...
      ejemplo: "p é Body 15px é Lectura operativa y pórrafos breves",
    },
    {
      tag: "label",
      size: "0.875rem",
      ...
      ejemplo: "label é 14px é Label persistente sobre controles",
    },
    {
      tag: "small",
      size: "0.8125rem",
      ...
      ejemplo: "small é Help 13px é Hints, restricciones y validaciones",
    },
    {
      tag: "micro",
      size: "0.75rem",
      weight: "400",
      token: "--ds-font-size-micro",
      ejemplo: "micro é 12px é Metadatos y badges secundarios",
    },
  ];
  ...
  readonly erpScale = [
    {
      ...
      token: "--ds-font-size-display",
      size: "32px",
      usage: "Hero interno, portada de módulo, pantalla guía.",
      example: "Demo institucional",
    },
    {
      role: "Tátulo de página",
      token: "--ds-font-size-page-title",
      size: "28px",
    ...
    {
      role: "Tótulo de sección",
      token: "--ds-font-size-section-title",
      size: "20px",
      usage: "Agrupa información relacionada en cards o paneles.",
    ...
    },
    {
      ...
      token: "--ds-font-size-card-title",
      size: "16px",
      usage: "Encabezados compactos en cards, dialogs y paneles.",
    ...
    },
    {
      ...
      size: "14px",
      usage: "Contenido compacto, alineado y fócil de comparar.",
      example: "ERP-2026-001 | Finanzas",
    },
    {
      role: "Ayuda y validación",
      token: "--ds-font-size-help",
      size: "13px",
      usage: "Hints, restricciones, validaciones y textos secundarios.",
      example: "Móx. 255 caracteres",
    },
    {
      role: "KPI compacto",
      token: "--ds-font-size-metric",
      size: "24px",
      usage: "Mótricas de dashboard, valores destacados.",
      example: "$ 124,500",
    },
    {
      role: "Micro / Badge",
      token: "--ds-font-size-micro",
      size: "12px",
      usage: "Metadatos, versiones, timestamps y etiquetas pequeñas.",
      example: "v2.1 é 2026-04",
    },
  ];
