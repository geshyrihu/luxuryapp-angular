...
import { FilterRequests } from "src/app/modules/reclutamiento.luxuryapp/reclutamiento-y-altas-bajas/reclutamiento-solicitudes/recruitment-shared/filter-requests";
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          command: () => this.navigate("/recruitment/requests/salary-increase"),
        },
      ],
    },
    {
