...
import { IEmployee } from "src/app/modules/reclutamiento.luxuryapp/expediente-del-empleado/employees/employees/interfaces/employee.interface";
@Injectable({
  providedIn: "root",
})
export class EmployeeInternalService {
  ...
  deleteBeneficiary(id: string) {
    return this._apiResponseS.onDelete(
      Endpoints.EmployeeBeneficiary.delete(id),
    );
  }
