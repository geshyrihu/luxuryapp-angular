...
export const recruitmentRoutes: Routes = [
  {
    path: "",
    loadComponent: () =>
      import("src/app/modules/reclutamiento.luxuryapp/recruitment-shell/recruitment-shell").then(
    ...
    children: [
      ...
      },
      {
        path: "staff-board",
        loadComponent: () =>
          import("src/app/modules/reclutamiento.luxuryapp/reclutamiento-y-altas-bajas/recruitment-staff-board/recruitment-staff-board").then(
      ...
      },
      {
        path: "requests",
        loadChildren: () =>
          import("src/app/modules/reclutamiento.luxuryapp/reclutamiento-y-altas-bajas/reclutamiento-solicitudes/recruitment-requests.routing").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("src/app/modules/reclutamiento.luxuryapp/solicitud-bajas/status-request-dismissal").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("src/app/modules/reclutamiento.luxuryapp/solicitud-modificaciones-sueldo/status-request-salary-modification").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("src/app/modules/reclutamiento.luxuryapp/reclutamiento-y-altas-bajas/recruitment-client-requests/solicitudes-cliente-list").then(
      ...
      },
      {
        path: "candidates",
        loadChildren: () =>
          import("src/app/modules/reclutamiento.luxuryapp/candidates.routing").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("src/app/modules/reclutamiento.luxuryapp/solicitud-bajas/solicitud-baja-list").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("src/app/modules/reclutamiento.luxuryapp/reclutamiento-y-altas-bajas/recruitment-staff-board/employee-form").then(
            (m) => m.EmployeeForm,
          ),
        data: {
      ...
      // =============================================================
      {
        ...
        loadComponent: () =>
          import("src/app/modules/reclutamiento.luxuryapp/expediente-del-empleado/employees/contract-renewal-list").then(
      ...
      // =============================================================
      {
        path: "employee-files",
        loadComponent: () =>
          import("src/app/modules/reclutamiento.luxuryapp/expediente-del-empleado/recursos-humanos/employee-file/employee-file-list").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("src/app/modules/reclutamiento.luxuryapp/expediente-del-empleado/recursos-humanos/employee-file/employee-file-detail").then(
      ...
      // =============================================================
      {
        path: "bank-data",
        loadComponent: () =>
          import("src/app/modules/reclutamiento.luxuryapp/expediente-del-empleado/recursos-humanos/employee-bank-data/employee-bank-data-list").then(
