...
export const candidatesRoutes: Routes = [
  ...
  },
  {
    path: "candidates",
    loadComponent: () =>
      import("src/app/modules/reclutamiento.luxuryapp/candidates/candidate-list").then(
        (m) => m.CandidateList,
      ),
  ...
  },
  {
    path: "applications",
    loadComponent: () =>
      import("src/app/modules/reclutamiento.luxuryapp/candidate-applications/candidate-application-list").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/reclutamiento.luxuryapp/candidates/former-employee-talent-pool/former-employee-talent-pool").then(
  ...
  },
  {
    path: "interviews",
    loadComponent: () =>
      import("src/app/modules/reclutamiento.luxuryapp/candidate-interview/candidate-interview-pending-list").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/reclutamiento.luxuryapp/candidate-interview/candidate-interview-response").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/reclutamiento.luxuryapp/candidate-interviewer-queue/candidate-interviewer-queue").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/reclutamiento.luxuryapp/candidate-work-position-candidates/candidate-work-position-candidates").then(
  ...
  },
  {
    path: "kpis",
    loadComponent: () =>
      import("src/app/modules/reclutamiento.luxuryapp/candidate-applications/candidate-application-kpis").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/reclutamiento.luxuryapp/candidate-recruitment-interviews/candidate-recruitment-interviews").then(
