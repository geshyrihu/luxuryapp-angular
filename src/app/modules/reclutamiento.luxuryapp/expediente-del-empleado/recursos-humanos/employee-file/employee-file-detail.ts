import { EmployeeDocumentList } from 'src/app/modules/reclutamiento.luxuryapp/employee-document/employee-document-list';
...
export class EmployeeFileDetail implements OnInit, OnDestroy {
