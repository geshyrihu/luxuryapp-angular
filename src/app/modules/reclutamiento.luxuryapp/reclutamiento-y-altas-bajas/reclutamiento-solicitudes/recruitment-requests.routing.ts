...
export const recruitmentRequestsRoutes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "vacancies",
        loadComponent: () =>
          import("src/app/modules/reclutamiento.luxuryapp/solicitud-vacantes/vacantes-list").then(
            (m) => m.VacantesList,
          ),
      ...
      },
      {
        path: "hirings",
        loadComponent: () =>
          import("src/app/modules/reclutamiento.luxuryapp/solicitud-altas/solicitud-alta-list").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("src/app/modules/reclutamiento.luxuryapp/solicitud-modificaciones-sueldo/solicitud-modificacion-list").then(
