      ...
      <div class="modal-header-info">
        ...
        <div class="info-row">
          ...
          <span class="value date">{{
            data.renewal.contractEndDate | date: "dd/MM/yyyy"
          }}</span>
        </div>
        <div class="info-row">
          ...
          <div class="performance-evaluation-banner warning">
            ...
            <div class="pe-banner-content">
              ...
              <span class="warning-text">
                Se requiere vincular una evaluación de desempeño completada para
        ...
        @if (form.get("decision")?.value === "NoRenovar") {
          <div class="r2-notice">
            ...
            <span>
              ...
              <code
                >// TODO: Enlazar con creación automática de RequestDismissal
                tras módulo de bajas.</code
              >
            </span>
          </div>
        }
...
export class ContractRenewalFormComponent implements OnInit {
  ...
  isPerformanceCompleted = computed(() => {
    ...
    return (
      renewal.status === "Decidido" || renewal.status === "EvaluacionCompletada"
    );
  });
