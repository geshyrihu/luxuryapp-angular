...
import { CreateOrdenCompraWizard } from "@supplier.luxuryapp/purchase-orders/purchase-order/create-purchase-order-wizard/create-orden-compra-wizard";
import { OrdenCompraDatosPago } from "@supplier.luxuryapp/purchase-orders/purchase-order/forms/orden-compra-datos-pago";
...
import { FundingUploadInvoicesModal } from "./modal-funding-upload-invoices";
...
export class FundingDetail {
  ...
  constructor() {
    this.createOrderItems = Object.keys(TipoGasto)
