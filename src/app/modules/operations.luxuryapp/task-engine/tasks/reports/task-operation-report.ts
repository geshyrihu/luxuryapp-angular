...
import { TaskReportActions } from "@operations.luxuryapp/task-engine/tasks/task-report-actions/task-report-actions";
import { TaskStatus } from "@operations.luxuryapp/task-engine/tasks/task-status/task-status";
  ...
  onSendReportClicked(): void {
    ...
    this.dialogHandlerS
      .openDialog(
        SendOperationReport,
        {
          year: this.TaskGroupService.year,
          numeroSemana: this.TaskGroupService.numeroSemana,
        },
