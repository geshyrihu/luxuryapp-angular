import { IonicMocks } from "@core/testing/ionic-mocks";
...
describe("ContainerDashboard", () => {
  ...
  beforeEach(async () => {
    mockAspRoleS = {
      hasAny: vi.fn(),
      anyOf: vi.fn(() => computed(() => false)),
      roleSignal: vi.fn(() => signal(null)),
    };
  ...
  it("should render MiEdificio when user is Condomino", () => {
    mockAspRoleS.hasAny.mockImplementation((roles: ApplicationRole[]) => {
