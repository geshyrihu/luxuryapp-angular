...
const CustomDocumentList = () =>
  import("@legal.luxuryapp/legal/committee/board-directors-library/biblioteca-consejo-directivo-detalle").then(
    ...
    children: [
      {
        ...
        loadComponent: () =>
          import("@legal.luxuryapp/legal/committee/board-directors-monthly-meetings/reuniones-mensuales-consejo-directivo").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("@legal.luxuryapp/legal/committee/board-directors-meeting-minutes/minutas-reuniones-consejo-directivo").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("@legal.luxuryapp/legal/committee/board-directors-meeting-minutes/minutas-reuniones-consejo-directivo-detalle").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("@legal.luxuryapp/legal/committee/building-insurance-policy/poliza-seguro-edificio").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("@legal.luxuryapp/legal/committee/board-directors-financial-reports/informes-financieros-consejo-directivo").then(
        ...
        children: [
          {
            path: "",
            loadComponent: () =>
              import("@legal.luxuryapp/legal/committee/board-directors-library/biblioteca-consejo-directivo").then(
