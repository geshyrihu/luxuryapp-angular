...
export const CONTABILIDAD_ROUTES: Routes = [
...

  {
    ...
    loadComponent: () =>
      import("src/app/modules/contabilidad.luxuryapp/general-ledger/contabilidad-online/presupuesto-contabilidad/presupuesto-contabilidad").then(
  ...
  // Ruta: /contabilidad/aspel-cobranza
  {
    path: "aspel-cobranza",
    loadComponent: () =>
      import("src/app/modules/cobranza.luxuryapp/aspel-cobranza-haus/aspel-cobranza-haus").then(
...

  {
    path: "mock-aspel",
    loadChildren: () =>
      import("../mock-aspel/mock-aspel.routes").then(
