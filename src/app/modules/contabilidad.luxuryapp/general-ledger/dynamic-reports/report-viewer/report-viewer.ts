...
import { AiAgentComponent } from "src/app/modules/contabilidad.luxuryapp/general-ledger/contabilidad-online/ai-agent/ai-agent";
import { reportFilterState } from "src/app/modules/contabilidad.luxuryapp/general-ledger/contabilidad-online/state/financial-report-filter.state";
import {
  IReportColumn,
  IReportResult,
  IReportResultRow,
