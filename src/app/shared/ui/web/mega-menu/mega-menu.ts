...
@Component({
  ...
  styles: [`
    ...
    app-mega-menu .p-megamenu-root-list > .p-menuitem > .p-menuitem-content .p-menuitem-link {
      padding: 0.625rem 1rem;
      font-size: var(--ds-font-size-body, 0.9375rem);
      color: var(--ds-text-primary);
    }
    app-mega-menu .p-megamenu-root-list > .p-menuitem-active > .p-menuitem-content .p-menuitem-link {
