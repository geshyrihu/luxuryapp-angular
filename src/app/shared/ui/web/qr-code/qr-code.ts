...
@Component({
  ...
  `,
  styles: [`
    .qr-root { display: flex; flex-direction: column; align-items: center; gap: 0.625rem; }
    .qr-label { font-size: var(--ds-font-size-label, 0.875rem); font-weight: 600; color: var(--ds-text-primary); margin: 0; }
    .qr-container {
      background: #fff;
    ...
    .qr-loading, .qr-empty { color: var(--ds-text-muted); display: flex; align-items: center; justify-content: center; width: 100%; height: 100%; }
