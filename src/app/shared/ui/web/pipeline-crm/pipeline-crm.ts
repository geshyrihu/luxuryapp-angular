      ...
      <div class="pipeline-stages">
        @for (stage of stages(); track stage.id) {
          <div class="pipeline-stage">
            <!-- Stage header -->
            <div class="pipeline-stage-header" [style.border-top-color]="stage.color || 'var(--ds-primary)'">
              <span class="pipeline-stage-name">{{ stage.name }}</span>
              <div class="pipeline-stage-meta">
                <span class="pipeline-stage-count">{{ stage.deals.length }}</span>
                @if (stageTotal(stage) > 0) {
                  <span class="pipeline-stage-value">{{ formatCurrency(stageTotal(stage)) }}</span>
                }
              </div>
            </div>
            ...
            <div class="pipeline-deals">
              @for (deal of stage.deals; track deal.id) {
                <div
                  ...
                  [class.pipeline-deal-priority-medium]="deal.priority === 'medium'"
                ...
                >
                  ...
                  <div class="pipeline-deal-footer">
                    @if (deal.value) {
                      <strong class="pipeline-deal-value">{{ formatCurrency(deal.value) }}</strong>
                    }
