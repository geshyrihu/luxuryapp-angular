...
@Component({
  ...
  styles: [`
    ...
    .main-spinner {
      ...
      background: conic-gradient(from 0deg, transparent 30%, var(--primary-500, #0b3164));
    ...
    .inner-spinner {
      ...
      animation: spin 1.5s reverse linear infinite; opacity: 0.5;
    }
    .loading-text {
      font-family: "Segoe UI", Roboto, Helvetica, Arial, sans-serif;
      font-size: 0.9rem; font-weight: 500; color: var(--primary-700, #072042);
