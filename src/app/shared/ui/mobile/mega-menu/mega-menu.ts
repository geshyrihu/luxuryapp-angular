      ...
      @for (category of items(); track $index) {
        <div class="ili-megamenu-category">
          ...
          >
            ...
            <app-icon
              [icon]="expandedCategory() === $index ? 'mdi:chevron-up' : 'mdi:chevron-down'"
            ...
            <div class="ili-megamenu-sub">
              @for (group of category.items; track $index) {
                <div class="ili-megamenu-group">
                  @if (group.label) {
                    <div class="ili-megamenu-group-label">{{ group.label }}</div>
                  }
                  @for (item of group.items; track $index) {
                    ...
                    >
                      @if (item.icon) {
                        <app-icon [icon]="item.icon" class="ili-megamenu-item-icon" />
                      }
