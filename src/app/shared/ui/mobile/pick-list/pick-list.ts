...
@Component({
        ...
        <div class="ili-pick-list-items">
          @for (item of source(); track $index) {
            <div class="ili-pick-list-item">
              <span class="ili-pick-list-label">{{ item.label || item.name || item }}</span>
              <button class="ili-pick-list-move" (click)="moveToTarget($index)" title="Mover a destino">
      ...
      <div class="ili-pick-list-column">
        ...
        <div class="ili-pick-list-items">
          @for (item of target(); track $index) {
            <div class="ili-pick-list-item">
              <button class="ili-pick-list-move" (click)="moveToSource($index)" title="Mover a origen">
  ...
  styles: [`
    ...
    .ili-pick-list-item:last-child { border-bottom: none; }
    .ili-pick-list-label {
      flex: 1;
