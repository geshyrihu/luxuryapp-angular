...
@Component({
  ...
  template: `
    <div class="ili-input-group">
      @if (addonBefore()) {
        <span class="ili-input-group-addon ili-input-group-addon-before">{{ addonBefore() }}</span>
      }
      <div class="ili-input-group-content">
        <ng-content />
      </div>
      @if (addonAfter()) {
        <span class="ili-input-group-addon ili-input-group-addon-after">{{ addonAfter() }}</span>
      }
    </div>
  `,
  styles: [`
