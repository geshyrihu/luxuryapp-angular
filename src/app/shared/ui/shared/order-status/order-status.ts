  ...
  template: `
    <div class="order-status-root" [class.order-status-vertical]="vertical()">
      @for (step of steps(); track $index; let i = $index) {
        <div
          class="order-step"
          [class.order-step-completed]="step.completed"
          [class.order-step-active]="step.active"
        >
          <div class="order-step-marker">
            ...
            @if (!vertical() && !$last) {
              <div
                class="order-step-line"
                [class.order-step-line-filled]="step.completed"
              ></div>
            }
          </div>
