...
import { EmployeeFileWorkPositionDTO } from "src/app/apps/reclutamiento.luxuryapp/expediente-del-empleado/recursos-humanos/employee-file/interfaces/employee-file.interfaces";
...
export class WorkContractFormComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    if (!employeeId || !workPositionId) { return; }
