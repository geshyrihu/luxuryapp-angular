...
import { MobileBottomNav, BottomNavItem } from "@ui/mobile/bottom-nav/bottom-nav";
  ...
  template: `
    <div class="p-4 fadein">
      ...
      <p class="text-secondary mb-6">
        Componentes de interfaz optimizados para mobile (iOS / Android).
        La arquitectura utiliza adaptadores internos ("ili-") para mantener el Core agnóstico.
      </p>
      
      <section class="mb-8">
        <h3 class="section-header">Pull to Refresh</h3>
        <div class="card p-0 overflow-hidden relative" style="max-width: 400px; height: 150px; border-radius: 8px; border: 1px solid var(--surface-border);">
      ...
      <section class="mb-8">
        ...
        <div class="card p-0 overflow-hidden" style="max-width: 400px; border-radius: 8px;">
          <ili-list-item>
      ...
      <section class="mb-8">
        ...
        <div class="border-round overflow-hidden" style="max-width: 400px; height: 120px; position: relative; background: var(--surface-card); border: 1px solid var(--surface-border);">
          <div class="p-4 text-center text-secondary">
...
export class MobileShowcaseComponent {
  ...
  navItems: BottomNavItem[] = [
    { id: 'home', icon: 'mdi:home-outline', activeIcon: 'mdi:home', label: 'Inicio' },
    { id: 'search', icon: 'mdi:magnify', label: 'Buscar' },
    { id: 'notifications', icon: 'mdi:bell-outline', activeIcon: 'mdi:bell', label: 'Alertas', badge: 3 },
    { id: 'profile', icon: 'mdi:account-outline', activeIcon: 'mdi:account', label: 'Perfil' }
  ];
