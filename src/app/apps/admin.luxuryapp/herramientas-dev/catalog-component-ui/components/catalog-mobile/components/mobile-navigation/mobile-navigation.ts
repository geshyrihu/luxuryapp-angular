    ...
    <div id="cat-nav-content" class="mobile-card">
      ...
      <div class="mobile-card-body flex flex-column gap-5">
        ...
        <div>
          ...
          <div class="flex flex-column gap-2">
            ...
            <div class="ds-header ds-header--medium">
              ...
              <span class="ds-header__title ds-header__title--lg"
                >Catalog Library</span
              >
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <p class="section-desc">
            Pestañas simples con lónea de acento en la activa.
          </p>
        ...
        <div>
          ...
          <div class="ds-segmented">
            <button class="ds-segmented__btn ds-segmented__btn--active">
              Day
            </button>
        ...
        <div>
          ...
          <p class="section-desc">
            Filtro por categoría. Reemplaza los tabs en vistas de lista.
          </p>
          <ion-segment
          ...
          >
            ...
            <ion-segment-button value="active"
              ><ion-label>Activos</ion-label></ion-segment-button
            >
            <ion-segment-button value="closed"
              ><ion-label>Cerrados</ion-label></ion-segment-button
            >
          </ion-segment>
          <p class="text-xs text-secondary mt-1">
            Seleccionado: <strong>{{ selectedSegment() }}</strong>
          </p>
        </div>
        ...
        <div>
          ...
          <p class="section-desc">
            Navegación principal inferior. Móximo 5 tabs. ócono + label
            obligatorios.
          </p>
          <ion-tabs
        ...
        <div>
          ...
          <ion-header
            style="position:relative;border:1px solid var(--ds-border,#e2e8f0);border-radius:12px;overflow:hidden;"
          >
            <ion-toolbar>
        ...
        <div>
          ...
          <p class="section-desc">
            Se abre desde <code>ion-menu-button</code> o
            <code>MenuController.open()</code>. Soporta tipos
            <code>overlay</code>, <code>reveal</code> y <code>push</code>.
          </p>
        ...
        <div>
          ...
          <p class="section-desc">
            FAB simple para acción primaria. FAB con lista
            (<code>ion-fab-list</code>) para 2-4 acciones secundarias.
          </p>
          <div class="fab-demos">
            <!-- FAB simple -->
              ...
              <div class="fab-demo-area">
                ...
                >
                  ...
                  <ion-fab-list side="top">
                    <ion-fab-button
                      color="success"
                      (click)="onFabAction('crear')"
                    >
                      <ion-icon name="add-outline"></ion-icon>
                    </ion-fab-button>
                    <ion-fab-button
                      color="primary"
                      (click)="onFabAction('editar')"
                    >
                      <ion-icon name="create-outline"></ion-icon>
                    </ion-fab-button>
                    <ion-fab-button
                      color="tertiary"
                      (click)="onFabAction('compartir')"
                    >
                      <ion-icon name="share-outline"></ion-icon>
                    </ion-fab-button>
                    <ion-fab-button
                      color="danger"
                      (click)="onFabAction('eliminar')"
                    >
