...
@Component({
  ...
  template: `
    <div class="mobile-card">
      ...
      <div class="mobile-card-body flex flex-column gap-4">
          ...
          <div class="flex flex-column gap-3">
            ...
            <div class="ds-card ds-card--project">
              <div class="ds-card__project-header">
                ...
                <span class="ds-chip-status ds-chip-status--active"
                  >ON TRACK</span
                >
              </div>
              <div class="ds-progress-compact">
                ...
                <div class="ds-progress-compact__track">
                  <div
                    class="ds-progress-compact__fill"
                    style="width:68%;"
                  ></div>
                </div>
              </div>
        ...
        <div>
          ...
          <div class="ds-avatar-bar">
            <div class="ds-avatar-status">
              ...
              <span
                class="ds-avatar-status__dot ds-avatar-status__dot--online"
              ></span>
            </div>
            <div class="ds-avatar-initials ds-avatar-initials--primary">JD</div>
            <div class="ds-avatar-stack">
              <div class="ds-avatar-stack__item ds-avatar-stack__item--primary">
                A
              </div>
              <div
                class="ds-avatar-stack__item ds-avatar-stack__item--secondary"
              >
                B
              </div>
          ...
          <ion-card style="margin:0;">
            ...
            <ion-card-content>
              ...
              <ion-item lines="full" style="--padding-start:0;">
                ...
                <span class="text-xs text-secondary" slot="end"
                  >15 Jun 2026</span
                >
              </ion-item>
          ...
          >
            <ion-accordion value="first">
              ...
              <div slot="content" style="padding:0.75rem 1rem;">
                <p class="text-sm m-0">
                  Nombre: Juan García ó RFC: GACJ800101ABC
                </p>
              </div>
            </ion-accordion>
            ...
            <ion-accordion value="third">
              ...
              <div slot="content" style="padding:0.75rem 1rem;">
                <p class="text-sm m-0">
                  INE é Constancia de situación fiscal ó CURP
                </p>
              </div>
            </ion-accordion>
          </ion-accordion-group>
        ...
        <div>
          <div class="font-bold text-sm mb-2">
            Eventos de Calendario (patrón Google Calendar)
          </div>
          <p class="text-xs text-secondary mb-2">
            Lista de eventos usando <code>ion-item</code> + tonal color de
            estado.
          </p>
          <ion-list
            lines="full"
              ...
              <ion-item detail="false" class="ion-no-padding">
                ...
                >
                  <ion-icon
                    name="calendar-outline"
                    [style.color]="
                      ev.own ? 'var(--ds-primary)' : 'var(--ds-text-muted)'
                    "
                  >
                  </ion-icon>
                </div>
        ...
        <div>
          ...
          <ion-grid
            style="border:1px solid var(--ds-border,#e2e8f0);border-radius:12px;overflow:hidden;padding:0.5rem;"
          >
            <ion-row>
              <ion-col size="6">
                <div
            ...
            <ion-row>
              <ion-col size="4">
                <div
                  style="background:var(--ds-bg-elevated,#f4f5f8);border-radius:8px;padding:0.5rem;text-align:center;"
                >
  ...
  styles: [
    `
      ...
      .ds-card__project-header {
        display: flex;
        justify-content: space-between;
        align-items: center;
        margin-bottom: 0.75rem;
      }
      .ds-card__project-footer {
        display: flex;
        justify-content: space-between;
        align-items: center;
        margin-top: 0.75rem;
      ...
      .ds-chip-status--active {
        background: var(--ds-info-light, #cae6ff);
        color: var(--ds-info, #002033);
      }
      ...
      .ds-metric-card--primary {
        background: var(--ds-primary);
        border-color: var(--ds-primary);
      }
      .ds-metric-card--primary .ds-metric-card__value,
      .ds-metric-card--primary .ds-metric-card__label {
      ...
      .ds-progress-compact__header {
        display: flex;
        justify-content: space-between;
        margin-bottom: 0.25rem;
      }
      .ds-progress-compact__track {
        height: 6px;
        background: var(--ds-border-strong);
        border-radius: 999px;
        overflow: hidden;
      }
      .ds-progress-compact__fill {
        height: 100%;
        background: var(--ds-primary);
        border-radius: 999px;
      }
  ...
  readonly calendarEvents = [
    {
      ...
      statusBg: "var(--ds-success-light,#d1fae5)",
      statusColor: "var(--ds-success,#006837)",
    },
    {
      id: 2,
      ...
      guests: 12,
      own: true,
      statusLabel: "Local (hist.)",
      statusBg: "var(--ds-info-light,#cae6ff)",
      statusColor: "var(--ds-info,#002033)",
    },
    {
      id: 3,
      title: "Reunión Proveedores",
      date: "20 Jun 09:00",
      guests: 2,
      own: false,
      statusLabel: "Solo local",
      statusBg: "var(--ds-warning-light,#fef3c7)",
      statusColor: "var(--ds-warning,#b45309)",
    },
    {
      id: 4,
      title: "Comité Finanzas",
      date: "28 Jun 11:00",
      guests: 5,
      own: true,
      statusLabel: "Pendiente sync",
      statusBg: "var(--ds-bg-elevated,#f4f5f8)",
      statusColor: "var(--ds-text-secondary,#64748b)",
    },
  ];
