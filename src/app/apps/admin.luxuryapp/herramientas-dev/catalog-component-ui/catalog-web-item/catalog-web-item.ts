    ...
    <section class="fadein">
      ...
      @switch (item()) {
            ...
            <div class="card">
              ...
              <div class="card-body">
                <p class="text-sm text-secondary m-0 mb-3">
                  ...
                  <code>&lt;button class="ds-icon-btn"&gt;</code> con tokens DS
                  en el SCSS. No uses <code>p-button</code> - sus variantes
                  cromíticas entran en conflicto con el estilo propio del botón.
                </p>
        ...
        @case ("custominputs") {
          ...
          <div class="card">
            <div class="card-body">
              header="Custom Inputs - Vertical layout (onlyInput)" class="mt-3"
              >
              <div class="grid">
                <div class="col-12 md:col-4">
                  <custom-input-text-signal
