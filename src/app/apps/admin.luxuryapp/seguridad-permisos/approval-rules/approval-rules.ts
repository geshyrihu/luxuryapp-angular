...
import { ApprovalScope } from "./models/approval-rules.enum";
import { ApprovalMatrixDto } from "./models/approval-matrix.dto";
import { UpdateApprovalRulesDto } from "./models/approval-rules-update.dto";
import { ApprovalRuleDto } from "./models/approval-rules.dto";
@Component({
