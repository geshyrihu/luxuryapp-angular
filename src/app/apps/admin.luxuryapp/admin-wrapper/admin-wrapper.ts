...
import { settingMenu } from "./admin-wrapper-menu";
import { MenuTone } from "./interfaces/menu-tone.interface";
...
export class AdminWrapper {
  ...
  private readonly defaultTone: MenuTone = {
    card: "border-primary",
    accent: "#003d9b",
    bgColor: "#edf1ff",
  ...
  private readonly toneByGroup: Record<string, MenuTone> = {
  ...
  public menuTone(group: string | null | undefined): MenuTone {
