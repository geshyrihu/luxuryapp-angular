...
import { ExcelExportService } from "src/app/apps/contabilidad.luxuryapp/general-ledger/contabilidad/presupuesto-propuesta/excel-export.service";
...
export class OwnerList {
  ...
  onLoadData() {
    const urlApi = Endpoints.RefactorResident.ownerListById(this.customerIdS.customerId());
    this.apiResponseS
      .onGetList(urlApi)
