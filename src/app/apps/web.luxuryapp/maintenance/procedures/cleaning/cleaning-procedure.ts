...
@Component({
  ...
  imports: [RouterModule, GraphModule],
  ...
  readonly graphNodes = [
    {
      ...
      data: {
        ...
        label: "Decisión 1",
        question: "¿El objeto funciona correctamente?",
      },
    },
    {
      id: "d1a",
      ...
      data: {
        type: "decision" as const,
        label: "Decisión 1a",
        question: "¿Tiene piezas reparables o valor como scrap?",
      },
    },
    {
      id: "d2",
      ...
      data: {
        type: "decision" as const,
        label: "Decisión 2",
        question: "¿Se necesita en la empresa / área?",
      },
    },
    {
      id: "d3",
      ...
      data: {
        type: "decision" as const,
        label: "Decisión 3",
        question: "¿Tiene valor comercial?",
      },
    },
    {
      id: "d4",
      ...
      data: {
        type: "decision" as const,
        label: "Decisión 4",
        question: "¿Está en condiciones de donarse?",
      },
    },
    {
      id: "d5",
      ...
      data: {
        type: "decision" as const,
        label: "Decisión 5",
        question: "¿Es material reciclable?",
      },
    },
    {
      id: "a1",
    ...
    },
    {
      ...
      data: {
        ...
        emoji: "🔄",
        text: "Enviar a reciclaje / taller",
      },
    },
    {
      id: "a3",
      ...
      data: {
        ...
        outcome: "good" as const,
        emoji: "✅",
        text: "Reintegrar al inventario / área",
      },
    },
    {
      id: "a4",
      ...
      data: {
        ...
        outcome: "good" as const,
        emoji: "💰",
        text: "Evaluar precio → Poner en venta",
      },
    },
    {
      id: "a5",
      ...
      data: {
        ...
        outcome: "good" as const,
        emoji: "🎁",
        text: "Donar a instituciones / empleados",
      },
    },
    {
      id: "a6",
      ...
      data: {
        ...
        outcome: "good" as const,
        emoji: "♻️",
        text: "Separar por tipo → Reciclaje",
      },
    },
    {
      id: "a7",
