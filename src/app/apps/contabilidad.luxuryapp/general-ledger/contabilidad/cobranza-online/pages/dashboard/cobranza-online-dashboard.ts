...
import { ChargeTemplateForm } from "src/app/apps/contabilidad.luxuryapp/general-ledger/contabilidad/cobranza-nativa/pages/charge-templates/charge-template-form";
