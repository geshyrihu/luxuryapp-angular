...
export class MockAspelDashboardComponent implements OnInit {
  ...
  refresh(resetPage = true): void {
    ...
    this.error.set("");
    const query = { ejercicio: this.year(), periodo: this.period(), nivel: this.nivel() ?? undefined, numCtaPapa: this.numCtaPapa() || undefined, page: this.page(), pageSize: 50 };
    ...
    this.mockAspelS.getSaldos({ ejercicio: this.year(), periodo: this.period(), nivel: this.nivel() ?? undefined, numCtaPapa: this.numCtaPapa() || undefined, page: 1, pageSize: 6 }).subscribe({
  ...
  openEstadoDeCuenta(movimiento: MovimientoResponse): void {
    ...
    this.mockAspelS.getEstadoDeCuenta(movimiento.numCta, { ejercicio: this.year() }).subscribe({
    ...
    this.mockAspelS.getSaldos({ ejercicio: this.year(), periodo: this.period(), numCta: movimiento.numCta, page: 1, pageSize: 1 }).subscribe({
  ...
  private loadFilterOptions(): void {
    ...
    this.mockAspelS.getMovimientoFilterOptions({ ejercicio: this.year(), periodo: this.period(), nivel: this.nivel() ?? undefined }).subscribe({
      next: (options) => {
