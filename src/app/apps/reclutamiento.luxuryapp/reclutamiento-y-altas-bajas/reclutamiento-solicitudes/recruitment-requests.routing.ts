...
export const recruitmentRequestsRoutes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "vacancies",
        loadComponent: () =>
          import("src/app/apps/reclutamiento.luxuryapp/reclutamiento-y-altas-bajas/reclutamiento-solicitudes/vacancy-requests/pages/vacantes-list").then(
            (m) => m.VacantesList,
          ),
      ...
      },
      {
        path: "hirings",
        loadComponent: () =>
          import("src/app/apps/reclutamiento.luxuryapp/reclutamiento-y-altas-bajas/reclutamiento-solicitudes/recruitment-requests/pages/solicitud-alta-list").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("src/app/apps/reclutamiento.luxuryapp/reclutamiento-y-altas-bajas/reclutamiento-solicitudes/salary-modification/pages/solicitud-modificacion-list").then(
