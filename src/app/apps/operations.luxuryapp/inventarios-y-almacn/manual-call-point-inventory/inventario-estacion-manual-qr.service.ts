...
export class InventarioEstacionManualQrService {
  ...
  async downloadQr(item: InventarioEstacionManualDto): Promise<void> {
  ...
  async downloadAllQr(items: InventarioEstacionManualDto[]): Promise<void> {
...
<body>
  ...
  private buildLabelBlock(qrDataUrl: string, item: InventarioEstacionManualDto): string {
