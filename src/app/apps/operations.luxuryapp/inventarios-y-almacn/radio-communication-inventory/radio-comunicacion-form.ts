...
import { RadioComunicacionFormDto } from "src/app/core/interfaces/radio-comunicacion-form.interface";
...
export class RadioComunicacionForm implements OnInit {
  ...
  async onLoadData(): Promise<void> {
    const result: RadioComunicacionFormDto = await this.apiResponseS.onGetItem(
