            ...
            @for (alert of activeAlerts(); track alert.id) {
              <div class="panic-card panic-card--active">
                <div class="panic-card__header">
                  ...
                  />
                  <div>
                    <span class="panic-card__name">{{
                      alert.triggeredByName
                    }}</span>
                    <span class="panic-card__time">{{
                ...
                @if (alert.latitude && alert.longitude) {
                  <a
                    class="panic-card__map"
                    [href]="getMapUrl(alert)"
                    target="_blank"
                    rel="noopener"
                  >
              ...
              <div class="panic-card">
                <div class="panic-card__header">
                  ...
                  <div>
                    ...
                    <span
                      class="panic-card__status-badge"
                ...
                @if (alert.attendedByName) {
                  <p class="panic-card__meta">
                    Atendida por {{ alert.attendedByName }} —
                    {{ formatTime(alert.attendedAt!) }}
                  </p>
                }
        ...
        <div class="panic-overlay" (click)="closeResolve()">
          <div class="panic-resolve-dialog" (click)="$event.stopPropagation()">
            ...
            <div class="panic-resolve-dialog__footer">
              <button
                type="button"
                class="panic-card__btn panic-card__btn--cancel"
                (click)="closeResolve()"
              >
                Cancelar
              </button>
