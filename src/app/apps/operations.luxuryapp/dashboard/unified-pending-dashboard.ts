...
import { SolicitudAltaStatusForm } from "src/app/apps/reclutamiento.luxuryapp/solicitud-altas/solicitud-alta-status-form";
import { VacanteForm } from "src/app/apps/reclutamiento.luxuryapp/solicitud-vacantes/vacante-form";
