...
describe('UnifiedPendingDashboardMobile', () => {
  ...
  beforeEach(() => {
    mockApiResponseS = { onGetList: vi.fn().mockResolvedValue([]), onPost: vi.fn() };
    mockCustomerIdS = { customerId: signal('cust-123') };
    mockDialogHandlerS = { openDialog: vi.fn().mockResolvedValue(undefined), sizeMd: '600px', sizeLg: '900px' };
  ...
  it('groupedData should group items by module', () => {
    component.allData = [
      { id: '1', module: 'Tickets', title: 'T1', status: 'Pendiente', date: '2024-01-01', formattedDate: '01/01/2024', responsible: 'User', urlRoute: '/test', priority: 1 },
      { id: '2', module: 'Tickets', title: 'T2', status: 'Pendiente', date: '2024-01-01', formattedDate: '01/01/2024', responsible: 'User', urlRoute: '/test', priority: 2 },
      { id: '3', module: 'Minutas', title: 'M1', status: 'Pendiente', date: '2024-01-01', formattedDate: '01/01/2024', responsible: 'User', urlRoute: '/test', priority: 3 },
    ];
    component.filterData();
  ...
  it('onNavigate should open ticket dialog for tickets', () => {
    const item: any = { module: 'Tickets', id: '1', metadata: { ticketGroupId: 'g1' }, title: 'Test Ticket' };
    component.onNavigate(item);
  ...
  it('onNavigate should open minuta dialog for minutas', () => {
    const item: any = { module: 'Minutas', id: '1', metadata: { meetingId: 'm1', areaResponsable: '2' } };
    component.onNavigate(item);
    expect(mockDialogHandlerS.openDialog).toHaveBeenCalled();
  });
