...
import { PurchaseLinkManager } from "src/app/features/purchasing/po/purchase-link-manager/purchase-link-manager";
import { OrdenCompraDatosAuthParcial } from "src/app/features/purchasing/po/purchase-order/parcials/orden-compra-datos-auth-parcial";
import { OrdenCompraDatosCotizacion } from "src/app/features/purchasing/po/purchase-order/parcials/orden-compra-datos-cotizacion";
import { OrdenCompraDatosPagoParcial } from "src/app/features/purchasing/po/purchase-order/parcials/orden-compra-datos-pago-parcial";
import { OrdenCompraStatusParcial } from "src/app/features/purchasing/po/purchase-order/parcials/orden-compra-status-parcial";
...
export class OrdenCompra implements OnInit {
  ...
  //----------------------------------------------------------------
  // 3. SEíALES COMPUTADAS (COMPUTED SIGNALS) PARA LíGICA DE UI
  //----------------------------------------------------------------
  // REFACTOR: Centralizamos la lígica condicional en `computed` signals.
  // Esto limpia el template y hace que la lígica sea mís fícil de mantener.
