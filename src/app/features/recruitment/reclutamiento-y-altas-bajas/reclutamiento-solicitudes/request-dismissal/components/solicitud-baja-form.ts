  ...
  styles: [
    `
      :host ::ng-deep {
        ...
        /*
          La librería posiciona el label como inline-block centrado (left:50% + translate).
...
export class SolicitudBajaForm implements OnInit {
  ...
  handleValueChange(newValue: any) {
    ...
    if (newValue == 0 || newValue == 2 || newValue == 4) {
      ...
      if (newValue == 3) {
        this.mensajeRenuncia =
          "Las evaluaciones están registradas en el sistema. No se requiere adjuntar documento manual.";
