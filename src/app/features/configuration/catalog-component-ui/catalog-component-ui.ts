...
export class CatalogComponentUi {
  ...
  complexDataExample = [
    { id: 1, name: "Medidor Eléctrico A1", folio: "E-1002", consumption: "120 kWh", status: EStatus.Concluido, icon: "flash-outline", color: "success" },
    { id: 2, name: "Medidor Agua Central", folio: "W-2005", consumption: "45 m³", status: EStatus.Proceso, icon: "water-outline", color: "primary" },
  ];
