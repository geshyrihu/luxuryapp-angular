...
const CustomDocumentList = () =>
  import("src/app/features/committee/board-directors-library/biblioteca-consejo-directivo-detalle").then(
    ...
    children: [
      {
        ...
        loadComponent: () =>
          import("src/app/features/committee/board-directors-monthly-meetings/reuniones-mensuales-consejo-directivo").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("src/app/features/committee/board-directors-meeting-minutes/minutas-reuniones-consejo-directivo").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("src/app/features/committee/board-directors-meeting-minutes/minutas-reuniones-consejo-directivo-detalle").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("src/app/features/committee/poliza-seguro-edificio/poliza-seguro-edificio").then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import("src/app/features/committee/board-directors-financial-reports/informes-financieros-consejo-directivo").then(
        ...
        children: [
          {
            path: "",
            loadComponent: () =>
              import("src/app/features/committee/board-directors-library/biblioteca-consejo-directivo").then(
