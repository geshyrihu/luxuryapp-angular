...
describe('CronogramaAnualMantenimiento', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: CronogramaMantenimientoService, useValue: cronogramaMantenimientoServiceMock },
  ...
  it('onLoadData should fetch and sort data', async () => {
    const items = [
      ...
      { id: 1, sistema: 'Alpha', nameMachinery: 'M1', maintenanceCalendars: [] },
    ];
  ...
  it('trackByFiltro should return filtro.id', () => {
    expect(component.trackByFiltro(0, { id: 'abc', emoji: '', nombre: '' })).toBe('abc');
  });
