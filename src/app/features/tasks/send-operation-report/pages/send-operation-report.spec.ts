...
describe('SendOperationReport', () => {
  ...
  it('onSelectAll should select all items', () => {
    component.destinatariosSignal.set([
      { email: 'a@a.com', selectControl: { value: false, setValue: vi.fn() }, select: false },
    ]);
  ...
  it('onDeselecteAll should deselect all items', () => {
    component.destinatariosSignal.set([
      { email: 'a@a.com', selectControl: { value: true, setValue: vi.fn() }, select: true },
    ]);
  ...
  it('onFilterDestinatarios should return filtered list', () => {
    component.destinatariosSignal.set([
      { email: 'a@a.com', nivelPrivacidad: 'PARA', selectControl: { value: true } },
      { email: 'b@b.com', nivelPrivacidad: 'CC', selectControl: { value: false } },
    ]);
