...
import { OrdenCompraDatosAuthParcial } from "src/app/features/purchases/purchase-order/parcials/orden-compra-datos-auth-parcial";
import { OrdenCompraDatosCotizacion } from "src/app/features/purchases/purchase-order/parcials/orden-compra-datos-cotizacion";
import { OrdenCompraDatosPagoParcial } from "src/app/features/purchases/purchase-order/parcials/orden-compra-datos-pago-parcial";
import { OrdenCompraStatusParcial } from "src/app/features/purchases/purchase-order/parcials/orden-compra-status-parcial";
