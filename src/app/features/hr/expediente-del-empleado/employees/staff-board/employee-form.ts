...
import { UpdatePasswordAccount } from "src/app/features/system/access/application-user/pages/update-password-account";
import { UpdateRole } from "src/app/features/system/access/application-user/pages/update-role";
