...
import { UpdatePasswordAccount } from "src/app/features/system/application-user/pages/update-password-account";
import { UpdateRole } from "src/app/features/system/application-user/pages/update-role";
import { EmployeeReclutamiento } from "../../../../recruitment/reclutamiento-y-altas-bajas/pages/employee-reclutamiento";
...
import { IncidentList } from "src/app/features/hr/expediente-del-empleado/recursos-humanos/incidencias-sanciones/incident/pages/incident-list";
@Component({
