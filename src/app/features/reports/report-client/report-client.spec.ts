...
describe('ReportClient', () => {
  ...
  beforeEach(() => {
    ...
    mockActivatedRoute = {
      snapshot: { params: { customer: 'cust-456', inicio: '2026-01-01', final: '2026-01-31' } },
    };

    TestBed.overrideComponent(ReportClient, { set: { template: '<div>Mock</div>', imports: [] } });
  ...
  it('should read params from ActivatedRoute and call API on init', () => {
    ...
    expect(component.rutaFinal).toBe('tasks/GetReportClient/cust-456/2026-01-01/2026-01-31');
    expect(mockApiResponseS.onGetList).toHaveBeenCalledWith(component.rutaFinal);
  });
