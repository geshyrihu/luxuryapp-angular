...
export class CatalogAuditItem {
  ...
  readonly bloques = [
    { titulo: "Advertencia", icono: "icon.alert", descripcion: "Riesgo fósico, legal o económico." },
    { titulo: "Nota", icono: "icon.information", descripcion: "Información complementaria." },
  ];
  ...
  iconifyIcon(cls: string): string { return resolveToIconify(cls, "icon.cog"); }
}
