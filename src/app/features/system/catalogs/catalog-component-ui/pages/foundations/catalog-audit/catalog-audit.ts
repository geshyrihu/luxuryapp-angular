            ...
            <div class="flex align-items-center gap-3">
              ...
              <div>
                <strong class="text-lg"
                  >{{ puntajeChecklist() }} / 15 ótems aprobados</strong
                >
                <p class="m-0 text-secondary text-sm">
                  {{
                    puntajeAprobatorio()
                      ? "Documento listo para publicación oficial."
                      : "Requiere correcciones obligatorias antes de publicar."
                  }}
                </p>
              </div>
            </div>
...
export class CatalogAudit {
  ...
  checklist = signal<ItemChecklist[]>([
    ...
    },
    {
      numero: 8,
      descripcion:
        "La tipografia corresponde al estandar: Inter para UI, Hanken Grotesk para headings, JetBrains Mono para codigo.",
      aprobado: false,
    },
    {
      numero: 9,
