      ...
      <div class="mobile-card-body flex flex-column gap-5">
        <div>
          ...
          <p class="section-desc">
            Primary, secondary, outline y text con altura base de 48px para mobile.
          </p>
          <div class="flex flex-column gap-2">
            ...
            <div class="flex gap-2">
              ...
              <button class="ds-btn ds-btn--primary ds-btn--flex ds-btn--disabled" disabled>
                Disabled
              </button>
            </div>
          </div>
        ...
        <div>
          ...
          <div class="flex flex-column gap-0">
            ...
            <ion-button-item [ionicIcon]="'star-outline'" label="Accion personalizada" />
          </div>
        </div>
        ...
        <div>
          ...
          <p class="section-desc">Versiones compactas para toolbars de 40x40px.</p>
