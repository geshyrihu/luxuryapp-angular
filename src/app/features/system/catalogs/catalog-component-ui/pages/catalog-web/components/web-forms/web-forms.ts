...
@Component({
  ...
  template: `
    <div class="grid">
      <!-- Formulario de solicitud ERP (patrón esténdar) -->
      <div class="col-12">
        <p-card header="Formulario ERP — Solicitud Operativa">
          <p class="m-0 mb-4 text-sm text-color-secondary">
            Patrón esténdar: labels persistentes (<code>custom-input-*</code>),
      ...
      <div class="col-12 lg:col-6">
        <p-card header="Formulario de Acceso">
          <p class="m-0 mb-4 text-sm text-color-secondary">
            Patrón login: email + contraseóa con indicador de fortaleza.
          </p>
          <form [formGroup]="loginForm" class="flex flex-column gap-3">
            ...
            @if (
              ...
              <p-message
                severity="error"
                text="Ingresa un correo electrónico vólido."
              />
            }
            <p-button
      ...
      <!-- Validación explócita de estados -->
      <div class="col-12 lg:col-6">
        <p-card header="Estados de Validación Explócitos">
          <p class="m-0 mb-4 text-sm text-color-secondary">
