...
export class WebEmptyStates {
  ...
  readonly rules = [
    { titulo: "Explica qué falta",     icon: "mdi:information",     color: "var(--ds-info)",    descripcion: "El mensaje debe decir exactamente por qué la pantalla esté vacóa." },
    ...
    { titulo: "Nunca pantalla vacóa",  icon: "mdi:close-circle",   color: "var(--ds-danger)",  descripcion: "Una pantalla en blanco sin contexto genera confusión y pórdida de confianza." },
  ];
}
