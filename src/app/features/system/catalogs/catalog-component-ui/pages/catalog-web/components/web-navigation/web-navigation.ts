          ...
          <p-stepper [(value)]="activeStep" [linear]="true">
            ...
            <p-step-panels>
              ...
              <p-step-panel [value]="1">
                <ng-template #content let-activateCallback="activateCallback">
                  <div class="p-4 surface-ground border-round flex flex-column gap-3">
                    <strong class="flex align-items-center gap-2"><app-icon icon="mdi:account" /> Datos Generales</strong>
                  ...
                  <div class="flex justify-content-end mt-3">
                    <p-button label="Siguiente" icon="mdi:arrow-right" iconPos="right"
              ...
              <p-step-panel [value]="2">
                <ng-template #content let-activateCallback="activateCallback">
                  <div class="p-4 surface-ground border-round flex flex-column gap-3">
                    <strong class="flex align-items-center gap-2"><app-icon icon="mdi:currency-usd" /> Datos Financieros</strong>
                    <div class="grid text-sm">
                  ...
                  <div class="flex justify-content-between mt-3">
                    <p-button label="Anterior" icon="mdi:arrow-left" severity="secondary" [outlined]="true"
              ...
              <p-step-panel [value]="3">
                <ng-template #content let-activateCallback="activateCallback">
                  <div class="p-4 surface-ground border-round flex flex-column gap-3">
                    <strong class="flex align-items-center gap-2"><app-icon icon="mdi:file-check" /> Documentos</strong>
...
export class WebNavigation {
  ...
  readonly homeItem: MenuItem = { icon: "mdi:home", command: () => {} };

  readonly iconTabs = [
    { value: "inbox",    label: "Bandeja",    icon: "mdi:inbox",         badge: 5,  badgeSeverity: "danger"  as const },
    { value: "sent",     label: "Enviados",   icon: "mdi:send",          badge: null, badgeSeverity: undefined },
    { value: "pending",  label: "Pendientes", icon: "mdi:clock-outline", badge: 3,  badgeSeverity: "warn"    as const },
    { value: "approved", label: "Aprobados",  icon: "mdi:check-circle",  badge: null, badgeSeverity: undefined },
  ];
  ...
  readonly accordionPanels = [
    ...
    { value: "2", header: "Documentos Adjuntos", icon: "mdi:paperclip",     tag: "3 archivos", tagSeverity: "info"     as const, content: "Contratos, cotizaciones y documentos de soporte. Formatos aceptados: PDF, DOCX, XLSX (míx. 10 MB por archivo)." },
    { value: "3", header: "Historial y Auditoróa", icon: "mdi:history",    tag: undefined,    tagSeverity: undefined,             content: "Registro inmutable de todos los cambios, aprobaciones y rechazos del ciclo de vida de este documento." },
  ];
  ...
  readonly step3Docs = [
    ...
    { name: "Justificación-túcnica.docx",  icon: "mdi:file-word-box",color: "var(--ds-info)",    status: "Pendiente", severity: "warn"      as const },
  ];
}
