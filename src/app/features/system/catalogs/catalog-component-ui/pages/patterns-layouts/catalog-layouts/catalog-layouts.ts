...
export class CatalogLayouts {
  ...
  readonly layoutRules = [
    { titulo: "Grid de 12 columnas",   icon: "icon.grid",           color: "var(--ds-primary)", descripcion: "Usa siempre PrimeFlex con col-12, md:col-6, lg:col-4. Nunca anchos en px para elementos del grid." },
    { titulo: "Max-width de contenido",icon: "icon.arrow-collapse-horizontal", color: "var(--ds-info)", descripcion: "En full-width, el contenido tiene max-width implócito del contenedor. En sidebar+content, el content ocupa el espacio restante." },
    { titulo: "Espaciado consistente", icon: "icon.arrow-expand-vertical", color: "var(--ds-success)", descripcion: "gap-4 entre bloques principales, gap-3 entre campos relacionados, gap-2 entre elementos inline." },
    { titulo: "Mobile primero",        icon: "icon.cellphone",       color: "var(--ds-warning)", descripcion: "Diseóa para col-12 primero. Expande con md:col-6 y lg:col-4. Los formularios siempre apilan en mobile." },
    { titulo: "Header fijo, no pegajoso", icon: "icon.page-layout-header", color: "var(--ds-danger)", descripcion: "El header de la app es sticky. El contenido de la página hace scroll debajo. Nunca pongas sticky en elementos de contenido." },
    { titulo: "Jerarquóa de acciones", icon: "icon.cursor-default-click", color: "var(--ds-primary)", descripcion: "Una acción primaria por vista. Las secundarias van a la derecha o en mení contextual. Danger siempre separado y confirmado." },
  ];
}
