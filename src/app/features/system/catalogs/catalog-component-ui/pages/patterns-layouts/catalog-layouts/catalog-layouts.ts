          ...
          >
            ...
            >
              ...
              <div class="flex gap-2">
                ...
                <div
                  class="border-round px-3 py-1 text-xs surface-card border-1 border-round text-white"
                  style="background:var(--ds-primary)"
                >
                  Nuevo
                </div>
                  ...
                  <div class="col-6 md:col-3">
                    ...
                    >
                      ...
                      <strong
                        ...
                        >{{ kpi.value }}</strong
                      >
                      <span class="text-xs" [style.color]="kpi.trendColor">{{
                        kpi.trend
                      }}</span>
                    </div>
                  </div>
              ...
              >
                ...
                @for (row of miniTableRows; track row.folio) {
                  ...
                  >
                    ...
                    <span class="flex-grow-1 text-color-secondary">{{
                      row.nombre
                    }}</span>
                    <span class="font-bold">{{ row.importe }}</span>
                    <span
                      class="border-round px-2 py-1 text-white text-xs"
...
export class CatalogLayouts {
  ...
  readonly miniTableRows = [
    {
      folio: "ERP-001",
      nombre: "Compra equipo TI",
      importe: "$45K",
      status: "Pendiente",
      statusColor: "var(--ds-warning)",
    },
    {
      folio: "ERP-002",
      nombre: "Mantenimiento elev.",
      importe: "$12K",
      status: "Proceso",
      statusColor: "var(--ds-info)",
    },
    {
      folio: "ERP-003",
      nombre: "Mobiliario admin.",
      importe: "$89K",
      status: "Aprobado",
    ...
    {
      folio: "ERP-004",
      nombre: "Limpieza mensual",
      importe: "$8K",
      status: "Rechazado",
      statusColor: "var(--ds-danger)",
    },
  ];
