            ...
            <div>
              ...
              <div class="flex flex-wrap gap-4 align-items-center">
                <p-overlay-badge value="3" severity="danger">
                  <app-icon icon="icon.bell" class="text-3xl text-color" />
                </p-overlay-badge>
                <p-overlay-badge value="12" severity="warn">
                  <app-icon icon="icon.email" class="text-3xl text-color" />
                </p-overlay-badge>
                <p-overlay-badge severity="danger">
                  <app-icon icon="icon.account" class="text-3xl text-color" />
                </p-overlay-badge>
              </div>
            </div>
          </div>
        ...
        <p-card header="Chips - p-chip">
          <div class="flex flex-column gap-4">
            ...
            <div>
              ...
              <div class="flex flex-wrap gap-2">
                <p-chip label="Administrador" icon="icon.account-circle" />
                <p-chip label="Activo" icon="icon.check-circle" />
                <p-chip label="Mantenimiento" icon="icon.wrench" />
              </div>
            </div>
