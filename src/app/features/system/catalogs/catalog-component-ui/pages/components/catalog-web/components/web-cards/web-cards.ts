              ...
              <div class="col-12 md:col-6 xl:col-3">
                <div class="surface-card border-1 border-round p-4 flex flex-column gap-3 h-full"
                  ...
                  <div class="flex align-items-center gap-2">
                    <app-icon [icon]="kpi.trend > 0 ? 'icon.trending-up' : 'icon.trending-down'"
          ...
          <div class="flex flex-column gap-3">
            ...
            <div class="surface-card border-1 border-round overflow-hidden">
              <div class="flex align-items-center justify-content-between px-4 py-3 border-bottom-1 surface-border">
                ...
                <p-button label="Ver todas" size="small" [text]="true" icon="icon.arrow-right" iconPos="right" />
              </div>
              <div class="p-3 flex flex-column gap-2">
                @for (item of cardListItems; track item.folio) {
                  <div class="flex align-items-center gap-2 p-2 hover:surface-hover border-round cursor-pointer">
                    <app-icon icon="icon.file-document-outline" class="text-color-secondary" />
                    <div class="flex-grow-1">
            ...
            <div class="surface-card border-1 border-round overflow-hidden">
              <div class="p-4">
                ...
                <div class="mt-3 flex align-items-center gap-2">
                  <app-icon icon="icon.currency-usd" class="text-color-secondary" />
...
export class WebCards {
  ...
  readonly kpis = [
    { label: "Ingresos del mes", value: "$1.24M",  icon: "icon.currency-usd",    color: "var(--ds-primary)",  bg: "var(--ds-primary-container)", trend: 12 },
    { label: "Solicitudes",      value: "348",      icon: "icon.file-document",   color: "var(--ds-info)",     bg: "var(--ds-info-light)",        trend:  8 },
    { label: "Tareas pendientes",value: "24",       icon: "icon.clock-outline",   color: "var(--ds-warning)",  bg: "var(--ds-warning-light)",     trend: -3 },
    { label: "Uptime del sistema",value: "99.8%",   icon: "icon.server-network",  color: "var(--ds-success)",  bg: "var(--ds-success-light)",     trend:  1 },
  ];

  readonly accentCards = [
    { severity: EStatus.Concluido,    title: "Pago procesado correctamente",     subtitle: "Ref. PAG-2026-0412 é Finanzas",       icon: "icon.check-circle",   color: "var(--ds-success)",  status: EStatus.Concluido    },
    { severity: EStatus.Proceso,      title: "Revisión de contrato en curso",    subtitle: "Ref. CONT-2026-0089 é Legal",          icon: "icon.file-search",    color: "var(--ds-warning)",  status: EStatus.Proceso      },
    { severity: EStatus.Pendiente,    title: "Aprobación de presupuesto",        subtitle: "Ref. PRES-2026-0031 é Dirección",      icon: "icon.clock-alert",    color: "var(--ds-info)",     status: EStatus.Pendiente    },
    { severity: EStatus.noAutorizado, title: "Solicitud rechazada por política", subtitle: "Ref. SOL-2026-0218 é Administración",  icon: "icon.close-circle",   color: "var(--ds-danger)",   status: EStatus.noAutorizado },
  ];
  ...
  readonly horizontalCards = [
    { title: "Mantenimiento preventivo", sub: "Próxima revisión: 30 Jun 2026",  icon: "icon.wrench",         color: "var(--ds-warning)", bg: "var(--ds-warning-light)", tag: "Programado",  severity: "warn"      as const },
    { title: "Factura #INV-0089",        sub: "Vence el 15 Jul 2026 é $12,500", icon: "icon.receipt",        color: "var(--ds-info)",    bg: "var(--ds-info-light)",    tag: "Pendiente",   severity: "info"      as const },
    { title: "Acceso de contratista",    sub: "Aprobado por Dirección",          icon: "icon.account-hard-hat",color: "var(--ds-success)", bg: "var(--ds-success-light)", tag: "Autorizado",  severity: "success"   as const },
  ];
}
