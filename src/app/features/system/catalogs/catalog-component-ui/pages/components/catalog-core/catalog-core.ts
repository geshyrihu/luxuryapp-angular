            ...
            <div class="flex flex-column gap-4">
              ...
              >
                ...
                <div class="flex gap-3 text-2xl text-primary">
                  <app-icon icon="icon.account" />
                  <app-icon icon="icon.cog" />
                  <app-icon icon="icon.bell" />
                </div>
              </div>
...
export class CatalogCore {
  ...
  readonly wizardSteps: WizardStep[] = [
    { value: 1, label: "Datos", icon: "icon.file-document-outline" },
    { value: 2, label: "Revision", icon: "icon.eye-outline" },
    { value: 3, label: "Confirmar", icon: "icon.check-circle-outline" },
  ];
