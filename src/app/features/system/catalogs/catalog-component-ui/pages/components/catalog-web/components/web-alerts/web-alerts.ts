    ...
    <div class="grid">
      ...
      <div class="col-12 lg:col-6">
        <p-card header="Auto-dismiss vs. Sticky">
          <p class="m-0 mb-3 text-sm text-color-secondary">
            <code>[life]="ms"</code> descarta el mensaje automíticamente.
      ...
      <div class="col-12">
        <p-card header="Toast Notifications">
          <p class="m-0 mb-3 text-sm text-color-secondary">
            Flotan en pantalla y desaparecen automíticamente (4 s). ósalos para confirmar acciones,
          ...
          <div class="flex flex-wrap gap-2 mb-4 p-3 border-round surface-ground">
            ...
            <p-button label="Míltiples" severity="secondary" [outlined]="true"
          ...
          <div class="grid">
            <div class="col-12 md:col-4">
              ...
              <div class="flex align-items-center gap-2 p-2 border-round border-1"
                ...
                <app-icon icon="icon.check-circle" style="color:var(--ds-success)" />
            ...
            <div class="col-12 md:col-4">
              ...
              <div class="flex align-items-center gap-2 p-2 border-round border-1"
                ...
                <app-icon icon="icon.alert" style="color:var(--ds-warning)" />
                <span class="text-sm">abc123</span>
              </div>
              <p-message severity="warn" text="Contraseóa dóbil. Agrega símbolos." styleClass="mt-1 block" />
            </div>
            <div class="col-12 md:col-4">
              ...
              <div class="flex align-items-center gap-2 p-2 border-round border-1"
                ...
                <app-icon icon="icon.close-circle" style="color:var(--ds-danger)" />
...
export class WebAlerts {
  ...
  readonly rules = [
    { severity: "success", label: "Success",       icon: "icon.check-circle",  color: "var(--ds-success)", bg: "var(--ds-success-light)", borderColor: "var(--ds-success)", when: "Operación completada, registro guardado, confirmación positiva." },
    { severity: "info",    label: "Info",           icon: "icon.information",   color: "var(--ds-info)",    bg: "var(--ds-info-light)",    borderColor: "var(--ds-info)",    when: "Contexto adicional, proceso en curso, ayuda no bloqueante." },
    { severity: "warn",    label: "Warning",        icon: "icon.alert",         color: "var(--ds-warning)", bg: "var(--ds-warning-light)", borderColor: "var(--ds-warning)", when: "Atención requerida, pendiente de revisión, riesgo moderado." },
    { severity: "error",   label: "Error / Danger", icon: "icon.close-circle",  color: "var(--ds-danger)",  bg: "var(--ds-danger-light)",  borderColor: "var(--ds-danger)",  when: "Error crótico, acción bloqueada, sin permisos, fallo del sistema." },
  ];
