...
@Component({
  ...
  template: `
    <form [formGroup]="webForm" class="flex flex-column gap-3">
      <!-- Texto, Bósqueda y Contraseóa -->
      <p-card header="Texto, Bósqueda y Contraseóa">
        <div class="grid">
      ...
      <!-- Numíricos -->
      <p-card header="Numíricos y Moneda">
        <div class="grid">
      ...
      <!-- Selección -->
      <p-card header="Selección y Bósqueda Avanzada">
        <div class="grid">
          ...
          <div class="col-12 lg:col-6">
            <custom-input-ng-select
              ...
              [items]="options"
              label="Ng-Select (bósqueda avanzada)"
              [horizontal]="false"
            />
          </div>
          <div class="col-12 lg:col-6">
      ...
      <!-- Especiales -->
      <p-card header="Especiales é Míscara, URL y Telófono">
        <div class="grid">
          <div class="col-12 lg:col-4">
          ...
          <div class="col-12 lg:col-4">
            <div class="flex flex-column gap-1">
              ...
              >
                ...
                >
                Componente de diólogo é se abre vía
      ...
      <p-card header="Toggles y Checkboxes">
        <div class="flex flex-wrap align-items-center gap-4">
          ...
          <custom-input-check-signal
            ...
            label="Acepto túrminos y condiciones"
          />
        </div>
      </p-card>
    </form>
