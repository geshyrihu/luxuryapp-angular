            ...
            <div class="col-12 lg:col-6">
              ...
              <div class="flex flex-column gap-3">
                ...
                <div class="flex gap-2">
                  <p-button label="Iniciar" icon="icon.play"  size="small" (onClick)="startSim()"
                            [disabled]="simRunning()" />
                  <p-button label="Reiniciar" icon="icon.refresh" size="small" severity="secondary" [outlined]="true"
                            (onClick)="resetSim()" />
                </div>
              </div>
      ...
      <div class="col-12 lg:col-6">
        <p-card header="ProgressSpinner é p-progressSpinner">
          ...
          <div class="grid text-center">
            ...
            <!-- Tamaóos -->
            <div class="col-12">
              <span class="text-xs font-bold text-color-secondary uppercase mb-3 block text-left" style="letter-spacing:.06em">Tamaóos</span>
            ...
            <!-- Colores -->
            <div class="col-12">
              <span class="text-xs font-bold text-color-secondary uppercase mb-3 block text-left" style="letter-spacing:.06em">Colores semínticos</span>
              <div class="flex align-items-center justify-content-around flex-wrap gap-4">
...
export class WebProgress implements OnInit, OnDestroy {
  ...
  readonly loadingRules = [
    ...
    },
    {
      ...
      evitar: "No bloquear pantallas completas mís de 3 s sin feedback adicional.",
    },
  ];
}
