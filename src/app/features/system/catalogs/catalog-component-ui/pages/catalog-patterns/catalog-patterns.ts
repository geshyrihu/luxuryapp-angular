    ...
    <section class="fadein">
      <div class="section-header mb-4">
        ...
        <p class="text-secondary">
          Combinaciones complejas para flujos de trabajo eficientes.
        </p>
      </div>
      <div class="grid">
        <div class="col-12">
        ...
        <div class="col-12 lg:col-8">
          <p-card header="Data Table Hybrid">
            ...
            <p-table [value]="[{id:1, name:'Pattern Test'}]" class="mt-2">
              <ng-template #header><tr><th>Acciones</th><th>Elemento</th><th>Status</th></tr></ng-template>
              <ng-template #body let-item>
                <tr>
                  <td><app-action-icons-group><custom-button-edit [label]="''" /><custom-button-delete [label]="''" /></app-action-icons-group></td>
                  <td>{{item.name}}</td>
