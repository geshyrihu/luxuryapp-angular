      ...
      <div class="grid">
                  ...
                  >
                    <div class="flex justify-content-between align-items-start mb-2">
                      <div>
                        ...
                        <span class="text-xs text-secondary">{{ item.folio }}</span>
                      </div>
                      <app-action-menu>
                        <custom-button-edit />
                    ...
                    <div class="flex align-items-center gap-2 mb-3">
                      <app-icon [icon]="item.icon" class="text-xl" [ngStyle]="{ color: 'var(--ds-' + item.color + ')' }" />
        ...
        <div class="col-12 lg:col-6">
          <p-card header="Login de referencia">
            <p class="m-0 mb-3 text-sm text-color-secondary">
              Vista de inicio de sesion como referencia de diseno. Demostracion no funcional del flujo de autenticacion.
            </p>
            <div class="surface-ground border-round p-4 flex flex-column gap-3" style="max-width: 400px">
              <div class="text-center mb-2">
                <div class="logo-box border-round-lg bg-primary flex align-items-center justify-content-center mx-auto mb-2" style="width: 48px; height: 48px">
                  <app-icon [icon]="'bolt'" class="text-white text-2xl" />
                </div>
                <h3 class="m-0 text-lg font-bold">LuxuryApp</h3>
                <span class="text-xs text-color-secondary">Sistema de gestion corporativa</span>
              </div>
              ...
              <div class="flex align-items-center gap-2">
                ...
                <label for="remember" class="font-normal text-sm">Recordar sesion</label>
              </div>

              <p-button label="Iniciar sesion" icon="mdi:login" styleClass="w-full" (onClick)="mockLogin()" />
              ...
              <div class="flex justify-content-between text-sm">
                <a class="cursor-pointer text-primary">Olvidaste tu password?</a>
        ...
        <div class="col-12 lg:col-6">
          <p-card header="Navegacion de referencia">
            <p class="m-0 mb-3 text-sm text-color-secondary">
              Patrones de navegacion del admin template: sidebar, tabs y breadcrumbs.
            </p>
            <div class="surface-ground border-round p-3 flex flex-column gap-3">
              ...
              <p-tabs value="0">
                ...
                <p-tabpanels>
                  ...
                  <p-tabpanel value="2"><p class="m-0 text-sm text-color-secondary">Contenido del panel Configuracion.</p></p-tabpanel>
                </p-tabpanels>
              </p-tabs>
            </div>
          </p-card>
