...
@Component({
  ...
  template: `
    ...
    <div class="mb-6">
      <h3 class="text-xl font-bold mb-1 border-bottom-1 border-300 pb-2">Tokens Semínticos Operacionales</h3>
      <p class="text-sm text-color-secondary mt-1 mb-4">
...
export class TokensColors {
  ...
  readonly paleta: TokenColor[] = [
    ...
    { nombre: "On Background", token: "--ds-on-background", uso: "Tútulos principales fuera de cards." },
  ];
  ...
  readonly semanticGroups: TokenGroup[] = [
    ...
    },
    {
      ...
      tokens: [
        { nombre: "Text Primary", token: "--ds-text-primary", uso: "Cuerpo principal, tútulos operativos." },
