    ...
    <div class="web-showcase">
      <section class="web-hero">
        ...
        <p class="web-hero__copy">
          La cobertura web debe demostrar cÛmo viven juntos los componentes
          dentro de mÛdulos reales: filtros, tablas, mÈtricas, acciones
          contextuales y navegaciÛn de detalle.
        </p>
      </section>
      ...
      <section class="web-panel">
        ...
        <p class="web-panel__copy">
          Igual que en mobile, el cat·logo web debe enseÒar pantallas armadas y
          no sÛlo una parrilla de controles sueltos.
        </p>
        ...
        <div class="web-gallery">
          <article class="web-screen">
            ...
            <div class="web-screen__hero">
              <strong>AutorizaciÛn de presupuesto</strong>
              <span
          ...
          <article class="web-screen">
            ...
            <div class="web-screen__stats">
              ...
              <div class="web-screen__stat">
                <span class="web-screen__muted">En revisiÛn</span>
                <strong>04</strong>
              </div>
              <div class="web-screen__stat">
              ...
              <div class="web-screen__list-item">
                <div class="web-screen__list-item-main">
                  ...
                  <span class="web-screen__muted"
                    >ValidaciÛn de wrappers y patrones base</span
                  >
                </div>
