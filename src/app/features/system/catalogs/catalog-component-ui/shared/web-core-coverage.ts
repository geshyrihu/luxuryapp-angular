...
@Component({
  ...
  styles: [`
    ...
    .web-hero {
      ...
      background:
        radial-gradient(circle at top left, color-mix(in srgb, var(--ds-primary) 14%, transparent), transparent 48%),
        linear-gradient(180deg, var(--ds-bg-surface, #ffffff), var(--ds-bg-sunken, #f8fafc));
      border: 1px solid color-mix(in srgb, var(--ds-border, #dbe3f0) 78%, transparent);
    ...
    .web-panel {
      ...
      border: 1px solid color-mix(in srgb, var(--ds-border, #dbe3f0) 82%, transparent);
    ...
    .web-screen {
      ...
      background: linear-gradient(180deg, var(--ds-bg-surface, #ffffff), var(--ds-bg-sunken, #f8fafc));
      border: 1px solid color-mix(in srgb, var(--ds-border, #dbe3f0) 78%, transparent);
      box-shadow: var(--ds-shadow-xs, 0 8px 24px rgba(15, 23, 42, 0.06));
    }

    .web-screen--dark {
      background: linear-gradient(180deg, color-mix(in srgb, var(--ds-text-primary, #0f172a) 96%, black), color-mix(in srgb, var(--ds-text-primary, #0f172a) 88%, black));
    ...
    .web-screen__badge {
      ...
      padding: 0 0.75rem;
      border-radius: 999px;
      background: color-mix(in srgb, var(--ds-primary) 12%, var(--ds-bg-surface, #ffffff));
    ...
    .web-screen__hero {
      ...
      padding: 1rem;
      border-radius: 1rem;
      background: color-mix(in srgb, var(--ds-primary) 6%, var(--ds-bg-surface, #ffffff));
    ...
    .web-screen__stat {
      ...
      border: 1px solid color-mix(in srgb, var(--ds-border, #dbe3f0) 70%, transparent);
    }
    ...
    .web-screen__metric-card {
      ...
      padding: 0.95rem;
      border-radius: 1rem;
      background: linear-gradient(180deg, var(--ds-bg-surface, #ffffff), color-mix(in srgb, var(--ds-primary) 4%, var(--ds-bg-sunken, #f8fafc)));
    ...
    .web-screen__table {
      border-radius: 1rem;
      overflow: hidden;
      border: 1px solid color-mix(in srgb, var(--ds-border, #dbe3f0) 75%, transparent);
      background: var(--ds-bg-surface, #ffffff);
    }
    ...
    .web-screen__table-row + .web-screen__table-row {
      border-top: 1px solid color-mix(in srgb, var(--ds-border, #dbe3f0) 70%, transparent);
    }
    ...
    .web-screen__dark-fill {
      ...
      background: linear-gradient(90deg, var(--ds-info, #38bdf8), var(--ds-primary, #0b3164));
    }
  ...
  template: `
    <div class="web-showcase">
      <section class="web-hero">
        ...
        <h3 class="web-hero__title">Pantallas objetivo antes que inventario plano</h3>
        <p class="web-hero__copy">
          La cobertura web debe demostrar cómo viven juntos los componentes dentro de módulos reales:
          filtros, tablas, métricas, acciones contextuales y navegación de detalle.
        </p>
      </section>

      <section class="web-panel">
        <div class="web-panel__eyebrow">Target Views</div>
        <h4 class="web-panel__title">Showroom de vistas objetivo para escritorio</h4>
        <p class="web-panel__copy">
          Igual que en mobile, el catálogo web debe enseñar pantallas armadas y no sólo una parrilla de controles sueltos.
        </p>
        ...
        <div class="web-gallery">
          <article class="web-screen">
            ...
            <div class="web-screen__hero">
              ...
              <span>Formulario con CTA primario, guardado parcial y datos clave en contexto.</span>
            </div>
            <div class="web-screen__actions">
              <button class="web-screen__cta web-screen__cta--primary" type="button">Enviar aprobación</button>
              <button class="web-screen__cta web-screen__cta--secondary" type="button">Guardar borrador</button>
            </div>
            ...
            <div class="web-screen__table">
              ...
              <div class="web-screen__table-row">
                ...
                <span class="web-screen__status web-screen__status--active">Validado</span>
                <strong>$120k</strong>
              </div>
              <div class="web-screen__table-row">
                <strong>Finanzas</strong>
                <span class="web-screen__status web-screen__status--review">Revisión</span>
                <strong>$125k</strong>
              </div>
            </div>
          </article>
            ...
            <div class="web-screen__list">
              <div class="web-screen__list-item">
                <div class="web-screen__list-item-main">
                  ...
                  <span class="web-screen__muted">Validación de wrappers y patrones base</span>
                </div>
              ...
              <div class="web-screen__list-item">
                <div class="web-screen__list-item-main">
                  ...
                  <span class="web-screen__muted">Cobertura release candidate</span>
                </div>
          ...
          <article class="web-screen">
            ...
            <div class="web-screen__tabs">
              <span class="web-screen__tab web-screen__tab--active">Overview</span>
            ...
            <div class="web-screen__toolbar">
              ...
              <button class="web-screen__cta web-screen__cta--primary" type="button">Nuevo</button>
            </div>
            <div class="web-screen__list">
              <div class="web-screen__list-item">
                <div class="web-screen__list-item-main">
                  <strong>Actividad reciente</strong>
                  <span class="web-screen__muted">14 movimientos en las últimas 4 horas</span>
                </div>
              ...
              <div class="web-screen__list-item">
                <div class="web-screen__list-item-main">
                  ...
                  <span class="web-screen__muted">Canales y automatizaciones saludables</span>
                </div>
