...
import {
  ...
  IApprovalMatrixDTO,
  IApprovalRuleDTO,
  IUpdateApprovalRulesDTO,
} from "../models/approval-rules.dto";
@Component({
...
export class ApprovalRules implements OnInit {
  ...
  loadMatrix(): void {
    ...
    this.apiResponseS
      .onGetItem<IApprovalMatrixDTO>(Endpoints.ApprovalRules.matrix)
      .then((data) => {
  ...
  onSave(): void {
    ...
    const rulesToSave: IApprovalRuleDTO[] = [];
    ...
    const dto: IUpdateApprovalRulesDTO = { rules: rulesToSave };
