...
import { IAsambleaChecklistTemplateAddOrEditDTO } from "./asamblea-checklist-template.dto";

interface IAsambleaChecklistTemplateForm {
...
export class AsambleaChecklistTemplateForm implements OnInit {
  ...
  form = new FormGroup<IAsambleaChecklistTemplateForm>({
  ...
  onLoadData() {
    this.apiResponseS
      .onGetItem<IAsambleaChecklistTemplateAddOrEditDTO>(
  ...
  onSubmit() {
    FormHelper.submitCrud({
      ...
      transformPayload: (value: IAsambleaChecklistTemplateAddOrEditDTO) => ({
        ...value,
