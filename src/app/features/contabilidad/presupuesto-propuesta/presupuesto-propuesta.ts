...
} from "src/app/features/contabilidad/presupuesto-propuesta/models/budget-proposal.model";
import { EquiposList } from "src/app/features/machinery/equipos-list";
...
export class PresupuestoPropuesta implements OnDestroy, OnInit {
  ...
  async auditProposal() {
    ...
    this.dialogHandlerS.openDialog(
      ...
      "🤖 Reporte de Auditoróa Presupuestal",
  ...
  forecastProposal() {
    ...
    this.dialogHandlerS
      .openDialog<
        any[]
      >(BudgetForecastDialog, { items: this.proposalItems(), inflationRate: this.inflationRate }, `📈 Proyección Financiera Inteligente ${this.selectedFiscalYear}`, this.dialogHandlerS.sizeFull)
