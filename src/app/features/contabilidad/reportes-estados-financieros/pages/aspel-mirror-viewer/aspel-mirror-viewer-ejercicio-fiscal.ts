...
// @Component({
//   selector: "app-aspel-mirror-viewer-ejercicio-fiscal",
//   templateUrl: "./aspel-mirror-viewer-ejercicio-fiscal.html",
...
//   ],
// })
// export class AspelMirrorViewerEjercicioFiscal implements OnInit {
...
//     this.apiResponseS
//       .onGetItem(
//         `Presupuesto/presupuesto-limpio-ejercicio-fiscal?customerId=${customerId}&intYear=${year}`,
//       )
//       .then((response: any) => {
