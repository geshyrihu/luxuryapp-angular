...
import { FundingExcelExportService } from "src/app/features/tenant/contabilidad/services/funding-excel-export.service";
import { FundingPurchaseDetail } from "src/app/features/tenant/funding/funding-purchase-detail";
import { FundingDetailDTO } from "src/app/features/tenant/funding/model/funding-detail-dto";
@Component({
...
export class FundingAccountingDetail {
  ...
  destroyRef = inject(DestroyRef); // Para la limpieza automÃ³tica de suscripciones.
  ...
  constructor() {
    // Efecto reactivo: cuando el customerId estÃ³ listo y cargado, carga los datos
    effect(() => {
