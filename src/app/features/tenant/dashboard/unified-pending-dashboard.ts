...
import { MinutaDetalleForm } from "src/app/features/tenant/juntas-comite/junta-comite-minutas/minuta-detalle-form";
import { ServiceOrderForm } from "src/app/features/tenant/service-order/service-order-form";
import { TaskForm } from "src/app/features/tenant/tasks/task-message/pages/task-form";
...
import { SolicitudAltaStatusForm } from "src/app/features/tenant/reclutamiento-solicitudes/recruitment-requests/components/solicitud-alta-status-form";
import { SolicitudBajaUpdateStatus } from "src/app/features/tenant/reclutamiento-solicitudes/request-dismissal/components/solicitud-baja-update-status";
import { ModificacionSalarioForm } from "src/app/features/tenant/reclutamiento-solicitudes/salary-modification/components/modificacion-salario-form";
import { VacanteForm } from "src/app/features/tenant/reclutamiento-solicitudes/vacancy-requests/components/vacante-form";
