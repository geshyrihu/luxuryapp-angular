...
import { BudgetProposalItemHistoryDTO } from "src/app/features/tenant/contabilidad/presupuesto-propuesta/models/budget-proposal.model";
@Component({
    ...
    this.apiResponseS
      ...
      .then((response) => {
        if (response) {
          ...
          this.errorMensaje = "No se encontrÃ³ historial para esta partida.";
        }
