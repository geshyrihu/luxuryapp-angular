...
export class OwnerList {
  ...
  private customCompare(x: string, y: string): number {
    ...
    // Si todos los elementos hasta ahora son iguales, el m�s corto es menor
