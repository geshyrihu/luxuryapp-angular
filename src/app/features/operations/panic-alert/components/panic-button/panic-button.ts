...
const EMITTER_ROLES: EApplicationRole[] = [
  ...
  EApplicationRole.Almacenista,
  EApplicationRole.Contador,
  EApplicationRole.Cobranza,
  EApplicationRole.JefeMantenimiento,
  EApplicationRole.TecnicoMantenimiento,
  EApplicationRole.Recepcionista,
  EApplicationRole.MasterConcierge,
  EApplicationRole.Concierge,
  EApplicationRole.JardineriaInterna,
  EApplicationRole.JefeSeguridadInterna,
  EApplicationRole.SeguridadInterna,
  EApplicationRole.Monitorista,
  EApplicationRole.EntrenadorGimnasio,
  EApplicationRole.SupervisorObra,
  EApplicationRole.Sistemas,
  EApplicationRole.Ludotecaria,
  EApplicationRole.Paqueteria,
  EApplicationRole.Chofer,
  EApplicationRole.BellBoy,
  EApplicationRole.SnackBar,
];
