...
export class InventarioHidranteQrService {
  ...
  async downloadQr(item: IInventarioHidrante): Promise<void> {
  ...
  async downloadAllQr(items: IInventarioHidrante[]): Promise<void> {
...
<body>
  ...
  private buildLabelBlock(qrDataUrl: string, item: IInventarioHidrante): string {
