...
export class InventarioDetectorHumoQrService {
  ...
  async downloadQr(item: IInventarioDetectorHumo): Promise<void> {
  ...
  async downloadAllQr(items: IInventarioDetectorHumo[]): Promise<void> {
...
<body>
  ...
  private buildLabelBlock(qrDataUrl: string, item: IInventarioDetectorHumo): string {
