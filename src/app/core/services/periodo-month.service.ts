...
export class PeriodMonthService {
  ...
  private periodoInicial$ = new BehaviorSubject<Date>(this.fechaInicial);
  ...
  private periodoFinal$ = new BehaviorSubject<Date>(this.fechaFinal);
