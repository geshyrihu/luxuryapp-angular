...
@Component({
  selector: "app-view-employee-desktop",
  imports: [RouterOutlet, Sidebar, HeaderEmployeedesktop, LxLoader],
  templateUrl: "./view-employee-desktop.html",
  changeDetection: ChangeDetectionStrategy.OnPush,
  styleUrl: "./view-employee-desktop.scss",
})
export class ViewEmployeedesktop implements OnInit, AfterViewInit {
