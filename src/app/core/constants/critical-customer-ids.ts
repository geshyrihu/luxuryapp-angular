 ...
 */
export type CriticalCustomerId = typeof CRITICAL_CUSTOMER_IDS[keyof typeof CRITICAL_CUSTOMER_IDS];
...
export function isCriticalCustomer(customerId: string): boolean {
  return Object.values(CRITICAL_CUSTOMER_IDS).includes(customerId as CriticalCustomerId);
}
