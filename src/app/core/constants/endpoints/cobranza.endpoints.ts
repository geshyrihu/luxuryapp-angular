    ...
    NativeCollection: {
      ...
      Charges: {
        ...
        bulkSetInitialBalance:
          "cobranza/charges/initial-balance/bulk",
      },
      Templates: {
        customer: (customerId: string) =>
          `cobranza/charge-templates/customer/${customerId}`,
        getById: (id: string) =>
          `cobranza/charge-templates/${id}`,
      ...
      Payments: {
        ...
        delete: (id: string) =>
          `cobranza/payments/${id}`,
        cancel: (id: string) =>
          `cobranza/payments/${id}/cancel`,
        applyToCharges:
          "cobranza/payments/apply-to-charges",
      },
      Statements: {
      ...
      Notifications: {
        ...
        sendStatementBatch:
          "cobranza/notifications/statements/send-batch",
      ...
      Reconciliation: {
        unallocated:
          "cobranza/reconciliations/unallocated",
        autoApplyAll:
          "cobranza/reconciliations/auto-apply-all",
      },
      LateFeePolicies: {
        customer: (customerId: string) =>
          `cobranza/late-fee-policies/customer/${customerId}`,
        getById: (id: string) =>
          `cobranza/late-fee-policies/${id}`,
      ...
      PropertyMembers: {
        ...
        createWithAccount:
          "cobranza/property-members/create-with-account",
        update: (id: string) =>
          `cobranza/property-members/${id}`,
        delete: (id: string) =>
          `cobranza/property-members/${id}`,
      ...
      RegulationArticles: {
        ...
        getById: (id: string) =>
          `cobranza/regulation-articles/${id}`,
      ...
      PropertyFines: {
        ...
        getById: (id: string) =>
          `cobranza/property-fines/${id}`,
        create: "cobranza/property-fines",
        update: (id: string) =>
          `cobranza/property-fines/${id}`,
        issueCharge:
          "cobranza/property-fines/issue-charge",
      ...
      Adjustments: {
        ...
        createCreditNote:
          "cobranza/adjustments/credit-notes",
      ...
      FinancialApprovals: {
        ...
        approve: (id: string) =>
          `cobranza/approvals/${id}/approve`,
        reject: (id: string) =>
          `cobranza/approvals/${id}/reject`,
        cancel: (id: string) =>
          `cobranza/approvals/${id}/cancel`,
      },
      PeriodClosures: {
        byCustomer: (customerId: string) =>
      ...
      Ledger: {
        ...
        chargeBalance: (chargeId: string) =>
          `cobranza/ledger/charge/${chargeId}/balance`,
        batchEntries: (batchId: string) =>
          `cobranza/ledger/batch/${batchId}`,
