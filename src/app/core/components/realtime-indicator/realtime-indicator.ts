...
@Component({
  ...
  styles: [`
    ...
    .rt-dot-live        { background: var(--ds-success, #006837); }
    .rt-dot-paused      { background: var(--ds-warning, #b45309); }
    .rt-dot-error       { background: var(--ds-danger, #ba1a1a); }
    .rt-dot-connecting  { background: var(--ds-info, #006477); animation: rt-blink 1s ease infinite; }
    /* Pulse ring */
    .rt-pulse {
      position: absolute;
    ...
    .rt-label { font-weight: 600; color: var(--ds-text-primary); }
    .rt-time  { color: var(--ds-text-muted); }
    .rt-latency {
...
export class AppRealtimeIndicator {
  ...
  dotClass(): string { return `rt-dot rt-dot-${this.status()}`; }
