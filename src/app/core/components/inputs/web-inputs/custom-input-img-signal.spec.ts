...
describe('CustomInputImg', () => {
  ...
  it('should have default contentHeight as 100', () => {
    expect(component.contentHeight()).toBe(100);
  });

  it('should have default contentWidth as 150', () => {
    expect(component.contentWidth()).toBe(150);
  });
  ...
  describe('computed - hasImage', () => {
    ...
    it('should return true when urlImgCurrent is provided and valid', () => {
      fixture.componentRef.setInput('urlImgCurrent', 'https://example.com/image.jpg');
      fixture.detectChanges();
      expect(component.hasImage()).toBe(true);
    });
  ...
  describe('computed - displayImageSrc', () => {
    ...
    it('should return urlImgCurrent when valid and no base64', () => {
      fixture.componentRef.setInput('urlImgCurrent', 'https://example.com/img.jpg');
      fixture.detectChanges();
