...
@Component({
  ...
  template: `
    @switch (variant()) {
      ...
      @case ("chart") {
        <div class="sk-chart">
          <p-skeleton width="100%" [height]="chartHeight()" borderRadius="8px" />
        </div>
      }
      @case ("form") {
        <div class="sk-form">
          @for (f of formFields(); track f) {
            <div class="sk-form-row">
              ...
              <p-skeleton width="100%" height="36px" borderRadius="6px" styleClass="sk-mt-1" />
            </div>
          }
          <p-skeleton width="120px" height="36px" borderRadius="6px" styleClass="sk-mt-3" />
        </div>
      }
      @case ("avatar") {
        <div class="sk-avatar-row">
          @for (a of repeatRows(); track a) {
            <div class="sk-avatar-item">
              ...
              <p-skeleton width="60px" height="12px" borderRadius="4px" styleClass="sk-mt-1" />
            </div>
          }
        </div>
      }
          ...
          @for (l of repeatRows(); track l) {
            <div class="sk-list-row">
              ...
              <div class="sk-list-text">
                ...
                <p-skeleton width="70%" height="12px" borderRadius="4px" styleClass="sk-mt-1" />
              </div>
            </div>
          }
        </div>
      ...
      @case ("stat") {
        <div class="sk-stat">
          ...
          <p-skeleton width="60%" height="28px" borderRadius="6px" styleClass="sk-mt-2" />
          <p-skeleton width="100px" height="12px" borderRadius="4px" styleClass="sk-mt-2" />
        </div>
      }
    }
  `,
