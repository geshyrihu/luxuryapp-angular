...
import { ContactCardBase } from "src/app/core/components/shared/contact-card/contact-card-base";

export { type ContactStatus } from "src/app/core/components/shared/contact-card/contact-card-base";
