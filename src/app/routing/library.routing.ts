...
import { EDocumentType } from "src/app/modules/legal.luxuryapp/asuntos-legales-y-seguros/interfaces/document-type.enum";
export const libraryRoutes: Routes = [
  {
    path: "incorporation-deed", // Ruta anterior: 'acta-constitutiva'
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/custom-documents/custom-document/acta-constitutiva-list").then(
...

  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/manuals/biblioteca/financial-report/informe-financiero-list").then(
...

  {
    path: "templates",
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/templates/templates-list").then(
        (m) => m.TemplatesList,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/manuals/biblioteca/manuals-and-processes/manuals-and-processes-list").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/manuals/biblioteca/manuals-and-processes/manuals-and-processes-guide/manuals-and-processes-guide").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/manuals/biblioteca/manuals-and-processes/manuals-and-processes-detail").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/manuals/biblioteca/manuals-and-processes/manuals-and-processes-editor/manuals-and-processes-editor").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/manuals/biblioteca/manuals-and-processes/manual-flowchart-editor/manual-flowchart-editor").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/custom-documents/custom-document/policy-contract/policy-contract-list").then(
...

  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/reports/contracts-policies/contracts-policies").then(
...

  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/custom-documents/custom-document/asambleas-list").then(
        (m) => m.Asambleas,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/custom-documents/custom-document/reglamentos-list").then(
        (m) => m.Reglamentos,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/custom-documents/custom-document/special-document-list").then(
...

  {
    ...
    loadComponent: () =>
      import("src/app/modules/supplier.luxuryapp/paint-inventory/inventario-pintura").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/supplier.luxuryapp/lighting-inventory/inventario-iluminacion").then(
