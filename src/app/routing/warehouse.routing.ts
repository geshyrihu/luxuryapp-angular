...
export const warehouseRoutes: Routes = [
  {
    path: "list",
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/inventarios-y-almacn/warehouse/warehouse-list").then(
        (m) => m.WarehouseList,
      ),
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/inventarios-y-almacn/product-exit/product-output-list").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/inventarios-y-almacn/product-entry/product-entry-list").then(
