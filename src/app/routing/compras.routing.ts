...
export const comprasRoutes: Routes = [
  ...
  //   path: "presupuesto/:id",
  //   loadComponent: () =>
  //     import("@accounting.luxuryapp/general-ledger/edicion-presupuesto/presupuesto-individual").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("@accounting.luxuryapp/ar/catalogo-gastos-fijos/catalogo-gastos-fijos-list").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("@accounting.luxuryapp/ar/catalogo-gastos-fijos/catalogo-gasto-fijo-form").then(
