...
export const calendarsRoutes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import("@maintenance.luxuryapp/planificacin-de-mantenimiento/maintenance-calendar-master/calendario-maestro-lista").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("@maintenance.luxuryapp/planificacin-de-mantenimiento/calendario-maestro-equipo/calendario-maestro-equipo").then(
  ...
  //   loadComponent: () =>
  //     import("@operations.luxuryapp/google-calendar/reuniones-comite/reuniones-comite").then(
  //       (m) => m.ReunionesComite,
  //     ),
  //   canActivate: [authGuard],
  //   data: {
