...
export const calendarsRoutes: Routes = [
  {
    ...
    loadComponent: () =>
      import("src/app/apps/operations.luxuryapp/google-calendar/calendar/fiestas-judias/fiestas-judias").then(
        (m) => m.FiestasJudias,
      ),
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/operations.luxuryapp/google-calendar/calendar/fiestas-cristianas/fiestas-cristianas").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/operations.luxuryapp/google-calendar/calendar/birthday/cumpleanos-list").then(
        (m) => m.Cumpleanos,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/mantenimiento.luxuryapp/planificacin-de-mantenimiento/maintenance-calendar-master/calendario-maestro-lista").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/operations.luxuryapp/google-calendar/calendar/fondeos/fondeos").then(
        (m) => m.Fondeos,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/mantenimiento.luxuryapp/planificacin-de-mantenimiento/calendario-maestro-equipo/calendario-maestro-equipo").then(
  ...
  //   loadComponent: () =>
  //     import("src/app/apps/operations.luxuryapp/google-calendar/reuniones-comite/reuniones-comite").then(
  //       (m) => m.ReunionesComite,
  //     ),
  //   canActivate: [authGuard],
  //   data: {
  ...
  // },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/operations.luxuryapp/google-calendar/google-calendar/google-calendar").then(
        (m) => m.GoogleCalendar,
      ),
    canActivate: [authGuard],
    data: {
