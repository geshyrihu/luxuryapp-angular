export const ROUTES = {
  ...
  PUBLICO: {
    REPORTE_OPERACION: (customer: string, inicio: string, final: string) =>
      ['/publico', 'reporte-operacion', customer, inicio, final],
    OPERATION_REPORT_CLIENT: (customer: string, inicio: string, final: string) =>
      ['/publico', 'operation-report-client', customer, inicio, final],
    REPORTE_MINUTA: (customer: string, id: string) =>
      ['/publico', 'reporte-minuta', customer, id],
    REPORTE_TICKET_PENDIENTES: (customerId: string, departamentId: string) =>
      ['/publico', 'reporte-ticket-pendientes-proveedor', customerId, departamentId],
    CONTABILIDAD_CLIENTE: (customerId: string, anio: string, mes: string) =>
      ['/publico', 'contabilidad-cliente', customerId, anio, mes],
  },
  ...
  COMITE: {
    HOME: ['/committee'],
    CONSEJO_DIRECTIVO: {
      REUNIONES_MENSUALES: ['/committee', 'board-directors', 'monthly-meetings'],
      MINUTAS: ['/committee', 'board-directors', 'meeting-minutes'],
      MINUTA_DETALLE: (id: string) =>
        ['/committee', 'board-directors', 'meeting-minutes-detail', id],
      POLIZA_SEGURO: ['/committee', 'board-directors', 'building-insurance-policy'],
      INFORMES_FINANCIEROS: ['/committee', 'board-directors', 'financial-reports'],
      DOCUMENTOS: ['/committee', 'board-directors', 'documents'],
      DOCUMENTO_INFORME_FINANCIERO: ['/committee', 'board-directors', 'documents', 'financial-report'],
      DOCUMENTO_PLANTILLAS: ['/committee', 'board-directors', 'documents', 'templates'],
      DOCUMENTO_MANUALES: ['/committee', 'board-directors', 'documents', 'manuals-and-processes'],
      DOCUMENTO_POLIZAS: ['/committee', 'board-directors', 'documents', 'maintenance-policy'],
      DOCUMENTO_ACTAS: ['/committee', 'board-directors', 'documents', 'incorporation-deeds'],
      DOCUMENTO_ASAMBLEAS: ['/committee', 'board-directors', 'documents', 'assemblies'],
      DOCUMENTO_REGLAMENTOS: ['/committee', 'board-directors', 'documents', 'regulations'],
      DOCUMENTO_CONTRATOS: ['/committee', 'board-directors', 'documents', 'employee-contracts'],
      DOCUMENTO_JUICIOS: ['/committee', 'board-directors', 'documents', 'lawsuits'],
      DOCUMENTO_PLANOS: ['/committee', 'board-directors', 'documents', 'blueprints'],
      DOCUMENTO_CONCESION_BARRANCA: ['/committee', 'board-directors', 'documents', 'ravine-concession'],
      DOCUMENTO_CONCESION_POZO: ['/committee', 'board-directors', 'documents', 'well-concession'],
    },
  },
  ...
  CONFIGURACION: {
    ...
    CLIENTES: ['/settings', 'clientes'],
    MODULOS_CLIENTE: ['/settings', 'customer-modul'],
    MODULO_CLIENTE_EDITAR: (customerId: string, customerName: string) =>
      ['/settings', 'customer-modul-edit', customerId, customerName],
    ROLES: ['/settings', 'roles'],
    MODULO_APP_ROL: ['/settings', 'module-app-rol'],
    MODULO_APP: ['/settings', 'module-app'],
    MODULO_APP_ROL_ACTUALIZAR: (roleId: string, roleName: string) =>
      ['/settings', 'module-app-rol-update', roleId, roleName],
    REGLAS_APROBACION: ['/settings', 'approval-rules'],
    DATOS_EMPRESA_CLIENTE: ['/settings', 'customer-data-company'],
    DATOS_EMAIL: ['/settings', 'datos-email'],
    DEPURACION: ['/settings', 'depuration'],
    BANCOS: ['/settings', 'banks'],
    FORMA_PAGO: ['/settings', 'forma-pago'],
    METODO_PAGO: ['/settings', 'metodo-pago'],
    USO_CFDI: ['/settings', 'uso-cfdi'],
    ...
    CATALOGO_CHECKLIST_ASAMBLEA: ['/settings', 'asamblea-checklist-catalog'],
    CONCILIACION_JUNTAS: ['/settings', 'juntas-mensuales-conciliacion'],
    CATALOGO_REVISIONES_INSPECCION: ['/settings', 'inspection-reviews-catalog'],
    CATALOGO_ACTIVO: ['/settings', 'catalog-asset'],
    ENTREGA_RECEPCION_CLIENTE: ['/settings', 'entrega-recepcion-cliente'],
  ...
  CONTABILIDAD: {
    ...
    COBRANZA_REPORTE_FINANCIERO: ['/contabilidad', 'collections', 'reporte-financiero'],
    COBRANZA_PRESUPUESTO: ['/contabilidad', 'collections', 'presupuesto-contabilidad'],
  ...
  DIRECTORIO: {
    ...
    EMPLEADO: (employeeId: string, applicationUserId: string) =>
      ['/directory', 'empleado', employeeId, applicationUserId],
  ...
  BIBLIOTECA: {
    ...
    MANUAL_DETALLE: (id: string) => ['/library', 'manuals-and-processes', 'detail', id],
    MANUAL_EDITOR: (id: string) => ['/library', 'manuals-and-processes', 'editor', id],
    MANUAL_FLUJO_EDITOR: (id: string) =>
      ['/library', 'manuals-and-processes', 'flowchart-editor', id],
  ...
  ENTREGA_RECEPCION: {
    ...
    MANTENIMIENTOS_PENDIENTES: ['/delivery-reception', 'mantenimientos-pendientes'],
  },
  ...
  JUNTAS_COMITE: {
    ...
    RESUMEN_MINUTA: (meetingId: string) =>
      ['/committee-meetings', 'resumen-minuta', meetingId],
    GESTION_MINUTA: (id: string) => ['/committee-meetings', 'gestion-minuta', id],
    MINUTAS_PENDIENTES: ['/committee-meetings', 'minuta-pendientes'],
    SEGUIMIENTO_MINUTAS: (area: string) =>
      ['/committee-meetings', 'seguimiento-minutas', area],
  },
  ...
  COMPRAS: {
    ...
    CUADRO_COMPARATIVO: (id: string) => ['/purchases', 'cuadro-comparativo', id],
    PRESENTACION_SOLICITUDES: ['/purchases', 'solicitud-compra-presentacion'],
    CATALOGO_GASTOS_FIJOS: ['/purchases', 'fixed-expenses-catalog'],
    GASTO_FIJO_FORM: (id: string) => ['/purchases', 'catalogo-gastos-fijos-form', id],
    ...
    PDF_SOLICITUD_PAGO: (id: string) => ['/purchases', 'solicitud-pago-pdf', id],
  ...
  BITACORAS: {
    ...
    ALBERCA_BITACORA: (piscinaId: string) => ['/logbook', 'piscina-bitacora', piscinaId],
    ...
    MI_INSPECCION: (customerInspectionId: string) =>
      ['/logbook', 'my-inspection', customerInspectionId],
    ...
    EXTINTOR_BITACORA: (extinguisherId: string) =>
      ['/logbook', 'fire-extinguisher-log', extinguisherId],
    EXTINTOR_CHECKLIST: (id: string) => ['/logbook', 'fire-extinguisher-checklist', id],
    SCANNER_EQUIPOS: ['/logbook', 'fire-equipment-scanner'],
    INSPECCION_EQUIPO: (code: string) => ['/logbook', 'equipment-inspection', code],
    HIDRANTE_BITACORA: (hydrantId: string) => ['/logbook', 'hydrant-log', hydrantId],
    HIDRANTE_CHECKLIST: (id: string) => ['/logbook', 'hydrant-checklist', id],
    ESTACION_MANUAL_BITACORA: (stationId: string) =>
      ['/logbook', 'manual-call-point-log', stationId],
    ESTACION_MANUAL_CHECKLIST: (id: string) =>
      ['/logbook', 'manual-call-point-checklist', id],
    DETECTOR_HUMO_BITACORA: (detectorId: string) =>
      ['/logbook', 'smoke-detector-log', detectorId],
    DETECTOR_HUMO_CHECKLIST: (id: string) =>
      ['/logbook', 'smoke-detector-checklist', id],
    PERIODOS_INSPECCION: ['/logbook', 'fire-inspection-periods'],
    CICLOS_INSPECCION: ['/logbook', 'fire-inspection-cycles'],
    CICLO_INSPECCION: (cycleId: string) => ['/logbook', 'fire-inspection-cycle', cycleId],
    PERIODO_EXTINTOR: (periodId: string) =>
      ['/logbook', 'fire-inspection-period-extintor', periodId],
    PERIODO_HIDRANTE: (periodId: string) =>
      ['/logbook', 'fire-inspection-period-hidrante', periodId],
    PERIODO_ESTACION: (periodId: string) =>
      ['/logbook', 'fire-inspection-period-estacion', periodId],
    PERIODO_DETECTOR: (periodId: string) =>
      ['/logbook', 'fire-inspection-period-detector', periodId],
  },
  ...
  RECLUTAMIENTO: {
    ...
    STATUS_MODIFICACION_SALARIO: ['/recruitment', 'status-solicitud-modificacion-salario'],
  ...
  REPORTES: {
    ...
    MANTENIMIENTO_RESUMEN: ['/report', 'maintenance-report', 'maintenances-summary'],
    MANTENIMIENTO_CONSUMOS: ['/report', 'maintenance-report', 'consumptions'],
    MANTENIMIENTO_ENTRADA_ALMACEN: ['/report', 'maintenance-report', 'warehouse-entry'],
    MANTENIMIENTO_SALIDA_ALMACEN: ['/report', 'maintenance-report', 'warehouse-exit'],
    MANTENIMIENTO_RECORRIDO: ['/report', 'maintenance-report', 'daily-tour'],
    MANTENIMIENTO_PRESTAMO_HERRAMIENTA: ['/report', 'maintenance-report', 'tool-loan-report'],
    MANTENIMIENTO_SOLICITUD_COMPRA: ['/report', 'maintenance-report', 'purchase-request-report'],
    MANTENIMIENTO_BITACORA_ALBERCA: ['/report', 'maintenance-report', 'pool-report'],
    ...
    SOPORTE_ORDEN_SERVICIO: (id: string) =>
      ['/report', 'maintenance-report', 'soporte-orden-servicio', id],
  },
  ...
  TICKETS: {
    ...
    MENSAJES: (ticketGroupId: string) => ['/tickets', 'messages', ticketGroupId],
    PENDIENTES: (ticketGroupId: string) =>
      ['/tickets', 'pending-board', ticketGroupId],
    MENSAJE: (ticketMessageId: string, ticketGroupId: string) =>
      ['/tickets', 'message', ticketMessageId, ticketGroupId],
    ...
    LEGAL: ['/tickets', 'legal'],
    LEGAL_GRUPO: (ticketGroupId: string) => ['/tickets', 'legal', ticketGroupId],
  },
  ...
  EVALUACION_EMPLEADOS: {
    ...
    PLANTILLA_EDITAR: (id: string) => ['/employee-evaluation', 'templates', 'edit', id],
    CONDUCTA_CREAR: ['/employee-evaluation', 'conduct', 'create'],
    CONDUCTA_EDITAR: (id: string) => ['/employee-evaluation', 'conduct', 'edit', id],
    CONDUCTA_LISTA: ['/employee-evaluation', 'conduct', 'list'],
    HISTORIAL_EMPLEADO: (employeeId: string) =>
      ['/employee-evaluation', 'employee', employeeId, 'history'],
  ...
  RECURSOS_HUMANOS: {
    ...
    PERMISO_DETALLE: (id: string) => ['/recursos-humanos', 'permiso', id, 'detalle'],
    ...
    VACACIONES_DETALLE: (id: string) =>
      ['/recursos-humanos', 'vacaciones', id, 'detalle'],
    ...
    ADMIN_BALANCES_VACACIONES: ['/recursos-humanos', 'admin-balances-vacaciones'],
    ...
    EXPEDIENTE: (employeeId: string) =>
      ['/recursos-humanos', 'employee-files', employeeId],
    ...
    NOMINA: {
      ...
      NOMINA_DETALLE: (id: string) =>
        ['/recursos-humanos', 'nomina', 'nominas', id, 'detalle'],
  ...
  IMPLEMENTACION_INICIAL: {
    ...
    PROYECTOS_PENDIENTES: ['/initial-implementation', 'pending-vendor-projects'],
