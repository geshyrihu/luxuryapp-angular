export const ROUTES = {
  ...
  RECURSOS_HUMANOS: {
    ...
    PLANTILLAS_CONTRATOS: ["/legal", "contract-templates"],
    ADENDAS: ["/legal", "contract-addendums"],
    PLANTILLAS_ADENDAS: ["/legal", "addendum-templates"],
    ...
    EXPEDIENTES: ["/recruitment", "employee-files"],
