...
| `/settings/clientes` | CustomerList |
| `/settings/customer-modul` | CustomerModulList |
| `/settings/customer-modul-edit/:customerId/:customerName` | CustomerModulEdit |
| `/settings/roles` | RolesList |
| `/settings/module-app-rol` | ModuleAppRol |
| `/settings/module-app` | ModuleAppList |
| `/settings/module-app-rol-update/:roleId/:roleName` | ModuleAppRolUpdate |
| `/settings/approval-rules` | ApprovalRules |
| `/settings/customer-data-company` | CustomerDataCompanyList |
| `/settings/datos-email` | EmailDataList |
| `/settings/depuration` | UpdateDataBase |
| `/settings/banks` | BankList |
| `/settings/forma-pago` | PaymentMethodList |
| `/settings/metodo-pago` | PaymentTypeList |
| `/settings/uso-cfdi` | CfdiUseList |
...
| `/settings/asamblea-checklist-catalog` | AsambleaChecklistTemplateList |
| `/settings/juntas-mensuales-conciliacion` | JuntasMensualesBackfill |
| `/settings/inspection-reviews-catalog` | CatalogoRevisionesInspeccion |
| `/settings/catalog-asset` | CatalogoActivoLista |
| `/settings/entrega-recepcion-cliente` | CatalogoDescripcionList |
...
| `/settings/ia-test` | IaTestComponent |
