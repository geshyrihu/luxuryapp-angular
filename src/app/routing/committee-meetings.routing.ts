...
export const committeeMeetingsRoutes: Routes = [
  {
    path: "sessions",
    loadComponent: () =>
      import("src/app/modules/direccion.luxuryapp/juntas-comite/juntas-mensuales-session/juntas-mensuales-session").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/direccion.luxuryapp/juntas-comite/presentacion-junta-comite/presentacion-junta-comite").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/direccion.luxuryapp/juntas-comite/presentacion-junta-comite/presentacion-junta-comite-contador").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/direccion.luxuryapp/juntas-comite/junta-comite-minutas/minutas-list").then(
        (m) => m.MinutasList,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/direccion.luxuryapp/juntas-comite/junta-comite-minutas/resumen-minuta").then(
        (m) => m.ResumenMinuta,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/direccion.luxuryapp/juntas-comite/junta-comite-minutas/meeting-management").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/direccion.luxuryapp/juntas-comite/junta-comite-minutas/minuta-pendientes").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/direccion.luxuryapp/juntas-comite/junta-comite-minutas/seguimiento-minutas").then(
