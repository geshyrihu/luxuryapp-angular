...
export const supervisionRoutes: Routes = [
  {
    path: "",
    loadComponent: () =>
      import("src/app/apps/operations.luxuryapp/supervision/supervision/master-dashboard/master-dashboard").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/operations.luxuryapp/supervision/supervision/agenda-supervision/agenda-supervision").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/operations.luxuryapp/supervision/supervision/minutas-resumen/minutas-resumen").then(
        (m) => m.MinutasResumen,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/operations.luxuryapp/supervision/supervision/reporte-tickets/reporte-tickets").then(
        (m) => m.ReporteTickets,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/operations.luxuryapp/supervision/supervision/resultado-general-grafico/resultado-general-grafico").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/operations.luxuryapp/supervision/supervision/resultado-general-posicion/resultado-general-posicion").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/operations.luxuryapp/supervision/supervision/resultado-general-evaluacion-areas/resultado-general-evaluacion-areas").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/operations.luxuryapp/supervision/supervision/resultado-general-dashboard/resultado-general-dashboard").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/operations.luxuryapp/supervision/supervision/presentaciones-juntas-comite/presentaciones-juntas-comite").then(
