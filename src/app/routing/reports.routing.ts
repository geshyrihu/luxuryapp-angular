...
export const reportsRoutes: Routes = [
  ...
  },
  {
    path: "access-history",
    loadComponent: () =>
      import("src/app/features/access-history/bitacora-acceso-list").then(
        (m) => m.BitacoraAcceso,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/service-order/resumen-ordenes-servicio").then(
  ...
  // Route removed because report is generated directly to PDF
  {
    ...
    loadComponent: () =>
      import("src/app/features/reports/pending-minutes/pending-minutes").then(
        (m) => m.PendingMinutes,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/reports/estados-financieros/estados-financieros").then(
