...
export const publicRoutes: Routes = [
  {
    ...
    loadComponent: () =>
      import("src/app/features/tenant/reports/report-client/report-client").then(
        (m) => m.ReportClient,
      ),
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/tenant/reports/operation-report-client/operation-report-client").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/tenant/reports/report-meeting/report-meeting").then(
        (m) => m.ReportMeeting,
      ),
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/tenant/reports/reporte-ticket-pendientes-proveedor/reporte-ticket-pendientes-proveedor").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/tenant/contabilidad/contabilidad-cliente/pages/contabilidad-cliente-wrapper").then(
        (m) => m.default,
      ),
    data: {
