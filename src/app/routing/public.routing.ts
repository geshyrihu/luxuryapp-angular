...
export const publicRoutes: Routes = [
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/reports/report-client/report-client").then(
        (m) => m.ReportClient,
      ),
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/reports/operation-report-client/operation-report-client").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/reports/report-meeting/report-meeting").then(
        (m) => m.ReportMeeting,
      ),
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/reports/reporte-ticket-pendientes-proveedor/reporte-ticket-pendientes-proveedor").then(
