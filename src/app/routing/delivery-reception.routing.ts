...
export const deliveryReceptionRoutes: Routes = [
  {
    path: "general",
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/delivery-receptions/client-delivery-reception/entrega-recepcion-cliente").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/delivery-receptions/delivery-reception/entrega-recepcion-equipos").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/delivery-receptions/delivery-reception/entrega-recepcion-instalaciones").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/delivery-receptions/delivery-reception/entrega-recepcion-herramientas").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/delivery-receptions/delivery-reception/entrega-recepcion-insumos").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/delivery-receptions/delivery-reception/entrega-recepcion-mantenimientos").then(
  ...
  },
  {
    ...
    path: "organigrama",
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/delivery-receptions/delivery-reception/entrega-recepcion-organigrama").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/delivery-receptions/delivery-reception/entrega-recepcion-llaves").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/delivery-receptions/delivery-reception/entrega-recepcion-hidrantes").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/delivery-receptions/delivery-reception/entrega-recepcion-mantenimientos-pendientes").then(
