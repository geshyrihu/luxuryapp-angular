...
export const deliveryReceptionRoutes: Routes = [
  {
    path: "general",
    loadComponent: () =>
      import("src/app/features/entrega-recepcion-cliente/entrega-recepcion-cliente").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/entrega-recepcion/entrega-recepcion-equipos").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/entrega-recepcion/entrega-recepcion-instalaciones").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/entrega-recepcion/entrega-recepcion-herramientas").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/entrega-recepcion/entrega-recepcion-insumos").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/entrega-recepcion/entrega-recepcion-mantenimientos").then(
  ...
  },
  {
    ...
    path: "organigrama",
    loadComponent: () =>
      import("src/app/features/entrega-recepcion/entrega-recepcion-organigrama").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/entrega-recepcion/entrega-recepcion-llaves").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/entrega-recepcion/entrega-recepcion-hidrantes").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/entrega-recepcion/entrega-recepcion-mantenimientos-pendientes").then(
