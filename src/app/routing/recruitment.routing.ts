...
export const recruitmentRoutes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/work-position/pages/work-position-list").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/recruitment/recruitment-client-requests/solicitudes-cliente-list").then(
