...
export const accountingRoutes: Routes = [
  ...
  },
  {
    path: "funding-list",
    loadComponent: () =>
      import("src/app/apps/contabilidad.luxuryapp/fondeos-y-reporteo/funding-accounting/funding-accounting-list").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/contabilidad.luxuryapp/fondeos-y-reporteo/funding-accounting/funding-accounting-detail").then(
  ...
  // },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/contabilidad.luxuryapp/ar/espejo-aspel/projected-expenses-list").then(
        (m) => m.default,
      ),
    canActivate: [authGuard],
    data: {
  ...
  // },
  {
    ...
    loadComponent: () =>
      import("src/app/apps/contabilidad.luxuryapp/ar/aspel-customer-empresa/aspel-customer-empresa-list").then(
  ...
  },
  {
    path: "aspel-sync",
    loadComponent: () =>
      import("src/app/apps/contabilidad.luxuryapp/ar/aspel-sync/aspel-sync").then(
