...
export const ticketsRoutes: Routes = [
  {
    path: "groups-list",
    loadComponent: () =>
      import("src/app/features/operations/task-engine/tasks/work-group/pages/task-group-list").then(
        (m) => m.TaskGroupList,
      ),
  ...
  },
  {
    path: "my-assignments",
    loadComponent: () =>
      import("src/app/features/operations/task-engine/tasks/my-tasks/pages/my-assigned-tasks-list").then(
  ...
  },
  {
    path: "my-requests",
    loadComponent: () =>
      import("src/app/features/operations/task-engine/tasks/my-tasks/pages/my-requests-task").then(
        (m) => m.MyRequestsTask,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/operations/task-engine/tasks/task-message/pages/task-list").then(
        (m) => m.TaskList,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/operations/task-engine/tasks/task-message/pages/task-pending-board").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/operations/task-engine/tasks/task-message/pages/task-view").then(
        (m) => m.TaskView,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    path: "reports",
    loadComponent: () =>
      import("src/app/features/operations/task-engine/tasks/task-message/pages/task-report").then(
        (m) => m.TaskReport,
      ),
    canActivate: [authGuard],
    data: {
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/operations/task-engine/tasks/reports/pages/task-report-resumen").then(
  ...
  },
  {
    path: "work-plan",
    loadComponent: () =>
      import("src/app/features/operations/task-engine/tasks/reports/pages/task-report-work-plan").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/operations/task-engine/tasks/reports/pages/task-report-work-plan-preview").then(
  ...
  },
  {
    path: "weekly-report",
    loadComponent: () =>
      import("src/app/features/operations/task-engine/tasks/reports/pages/task-operation-report").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/features/operations/task-engine/tasks/reports/pages/task-weekly-report-preview").then(
  ...
  },
  {
    ...
    path: "legal",
    loadComponent: () =>
      import("src/app/features/legal/asuntos-legales-y-seguros/ticket-legal/ticket-legal-lista-cliente").then(
