...
export const inventoriesRoutes: Routes = [
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/inventarios-y-almacn/inventory-engine-system/inventory-engine-system").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/inventarios-y-almacn/key-inventory/inventario-llaves-list").then(
...

  {
    path: "radios",
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/inventarios-y-almacn/radio-communication-inventory/radio-comunicacion-list").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/reports/mantenimiento-presupuesto/gastos-mantenimiento").then(
  ...
  },
  {
    path: "hydrants",
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/inventarios-y-almacn/hydrant-inventory/inventario-hidrante").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/inventarios-y-almacn/manual-call-point-inventory/inventario-estacion-manual").then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import("src/app/modules/operations.luxuryapp/inventarios-y-almacn/smoke-detector-inventory/inventario-detector-humo").then(
