...
htmlCode = htmlCode.replace(/Proyecci\u00f3n 2026/g, "Proyección {{ fiscalYear }}"); // Just in case it was encoded

fs.writeFileSync(htmlPath, htmlCode, 'utf8');

const pathAudit = "D:/repos/luxuryapp-api/client/angular/src/app/features/accounting/general-ledger/contabilidad/presupuesto-propuesta/budget-audit-dialog.ts";
...
const pathForecast = "D:/repos/luxuryapp-api/client/angular/src/app/features/accounting/general-ledger/contabilidad/presupuesto-propuesta/budget-forecast-dialog.ts";
