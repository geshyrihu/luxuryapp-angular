...
tsCode = tsCode.replace(
  /"Ocultar Anual 2026"/g,
  "`Ocultar Anual ${this.fiscalYear}`",
);
tsCode = tsCode.replace(
  /"Mostrar Anual 2026"/g,
...
htmlCode = htmlCode.replace(
  /class="surface-card border-1 surface-border border-round-md p-2 w-full flex flex-column align-items-center justify-content-center cursor-pointer hover:surface-hover transition-colors transition-duration-150"/g,
...
htmlCode = htmlCode.replace(
  /class="surface-card border-1 surface-border border-round-md p-2 w-full flex flex-column align-items-center justify-content-center cursor-pointer hover:surface-hover"/g,
  'class="bg-white shadow-1 hover:shadow-3 border-1 border-gray-200 border-round-xl p-2 w-full flex flex-column align-items-center justify-content-center cursor-pointer transition-all transition-duration-200"',
);
htmlCode = htmlCode.replace(
  /class="surface-card border-1 border-blue-200 border-round-md p-2 w-full flex flex-column align-items-center justify-content-center cursor-pointer hover:bg-blue-50 transition-colors transition-duration-150"/g,
...
htmlCode = htmlCode.replace(
  /class="surface-card border-1 border-green-300 border-round-md p-2 w-full flex flex-column align-items-center justify-content-center cursor-pointer hover:bg-green-50 transition-colors transition-duration-150"/g,
...
htmlCode = htmlCode.replace(
  /class="surface-card border-1 border-orange-300 border-round-md p-2 w-full flex flex-column align-items-center justify-content-center cursor-pointer hover:bg-orange-50 transition-colors transition-duration-150"/g,
