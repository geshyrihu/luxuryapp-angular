...
- Name: dashboard.spec.ts >> Dashboard >> debería mostrar tarjetas de estadísticas
- Location: e2e\specs\dashboard.spec.ts:11:7
...
Call log:
  - waiting for locator('custom-input-password-signal[id="password-global"] input').first()
    ...
    - main [ref=e4]:
      - generic [ref=e8]:
        ...
        - generic [ref=e12]:
          ...
          - generic [ref=e60]:
            - heading "Excelencia Inmobiliaria" [level=1] [ref=e64]
            - paragraph [ref=e65]: Gestiona recursos, proyectos y operaciones.
```
