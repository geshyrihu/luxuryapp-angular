...
Call log:
  - waiting for locator('custom-input-text-signal[id="username-global"]') to be visible
    35 × locator resolved to hidden <custom-input-text-signal label="Usuario" id="username-global" placeholder="Ej: jperez" customclass="h-3rem text-lg">…</custom-input-text-signal>
