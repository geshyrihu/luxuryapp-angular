...
- Name: dashboard.spec.ts >> Dashboard >> debería navegar a secciones del sidebar
- Location: e2e\specs\dashboard.spec.ts:22:7
...
Call log:
  - waiting for locator('custom-input-text-signal[id="username-global"]') to be visible
    38 × locator resolved to hidden <custom-input-text-signal label="Usuario" id="username-global" placeholder="Ej: jperez" customclass="h-3rem text-lg">…</custom-input-text-signal>
