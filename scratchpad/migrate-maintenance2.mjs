...
const files = globSync(`${FEATURES}/maintenance/**/*.html`);
const ionFiles = [];
...
console.log(`Found ${ionFiles.length} HTML files with ion- in maintenance/`);
...
for (const htmlPath of ionFiles) {
  ...
  if (ts.includes('"@ionic/angular/standalone"')) {
    ...
    const ionicComponents = [
      "IonItem", "IonLabel", "IonNote", "IonAvatar", "IonBadge", "IonButton", "IonSegment", "IonSegmentButton",
